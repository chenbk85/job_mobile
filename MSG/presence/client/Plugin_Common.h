...
#define jNET_COMMON_LIB_API 
#define aqSERVER_SIDE_LOGIG

#define PresenceServer_jNOTUSE_SQ_CODE
...
// 서버간 공유 시작 해더
//--------------------------------------------------------------------------
#define PT_PresenceServer_LIB_API 
#define jxDECL_PresenceServer jxDECL_NET
#define jxDEFINE_PresenceServer jxDEFINE_NET
