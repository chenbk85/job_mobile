...
void protobuf_ShutdownFile_game_2eproto() {
  ...
  delete GAnsUserUpdate::default_instance_;
...
void protobuf_AddDesc_game_2eproto() {
  ...
  GAnsUserUpdate::default_instance_ = new GAnsUserUpdate();
  ...
  GAnsUserUpdate::default_instance_->InitAsDefaultInstance();
...
#ifndef _MSC_VER
const int GAnsUserUpdate::kTypeFieldNumber;
const int GAnsUserUpdate::kUpdateInfoFieldNumber;
#endif  // !_MSC_VER

GAnsUserUpdate::GAnsUserUpdate()
  : ::google::protobuf::MessageLite() {
  SharedCtor();
}

void GAnsUserUpdate::InitAsDefaultInstance() {
}

GAnsUserUpdate::GAnsUserUpdate(const GAnsUserUpdate& from)
  : ::google::protobuf::MessageLite() {
  SharedCtor();
  MergeFrom(from);
}

void GAnsUserUpdate::SharedCtor() {
  _cached_size_ = 0;
  type_ = 0;
...
void GAnsUserUpdate::SharedDtor() {
...
void GAnsUserUpdate::SetCachedSize(int size) const {
  GOOGLE_SAFE_CONCURRENT_WRITES_BEGIN();
  _cached_size_ = size;
  GOOGLE_SAFE_CONCURRENT_WRITES_END();
}
const GAnsUserUpdate& GAnsUserUpdate::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_game_2eproto();  return *default_instance_;
}

GAnsUserUpdate* GAnsUserUpdate::default_instance_ = NULL;

GAnsUserUpdate* GAnsUserUpdate::New() const {
  return new GAnsUserUpdate;
}

void GAnsUserUpdate::Clear() {
  if (_has_bits_[0 / 32] & (0xffu << (0 % 32))) {
    type_ = 0;
    if (has_updateinfo()) {
      if (updateinfo_ != &::google::protobuf::internal::kEmptyString) {
...
bool GAnsUserUpdate::MergePartialFromCodedStream(
    ::google::protobuf::io::CodedInputStream* input) {
#define DO_(EXPRESSION) if (!(EXPRESSION)) return false
  ::google::protobuf::uint32 tag;
  while ((tag = input->ReadTag()) != 0) {
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 1: {
        ...
        if (input->ExpectTag(18)) goto parse_updateInfo;
        break;
      }
...
void GAnsUserUpdate::SerializeWithCachedSizes(
    ::google::protobuf::io::CodedOutputStream* output) const {
  // required int32 type = 1;
  if (has_type()) {
  ...
  if (has_updateinfo()) {
    ::google::protobuf::internal::WireFormatLite::WriteBytes(
      2, this->updateinfo(), output);
  }
  
}

int GAnsUserUpdate::ByteSize() const {
  int total_size = 0;
...
void GAnsUserUpdate::CheckTypeAndMergeFrom(
    const ::google::protobuf::MessageLite& from) {
  MergeFrom(*::google::protobuf::down_cast<const GAnsUserUpdate*>(&from));
}

void GAnsUserUpdate::MergeFrom(const GAnsUserUpdate& from) {
  GOOGLE_CHECK_NE(&from, this);
  if (from._has_bits_[0 / 32] & (0xffu << (0 % 32))) {
    if (from.has_type()) {
      set_type(from.type());
    ...
    if (from.has_updateinfo()) {
      set_updateinfo(from.updateinfo());
    }
  }
}

void GAnsUserUpdate::CopyFrom(const GAnsUserUpdate& from) {
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool GAnsUserUpdate::IsInitialized() const {
  if ((_has_bits_[0] & 0x00000003) != 0x00000003) return false;
  
  return true;
}

void GAnsUserUpdate::Swap(GAnsUserUpdate* other) {
  if (other != this) {
...
::std::string GAnsUserUpdate::GetTypeName() const {
  return "GAnsUserUpdate";
}
...
const GAnsProtocol_Type GAnsProtocol::GANSUSERUPDATE;
...
const int GAnsProtocol::kAnsUpdateFieldNumber;
#endif  // !_MSC_VER
...
void GAnsProtocol::InitAsDefaultInstance() {
  ...
  ansupdate_ = const_cast< ::GAnsUserUpdate*>(&::GAnsUserUpdate::default_instance());
}
  ...
  while ((tag = input->ReadTag()) != 0) {
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 8: {
        ...
        if (input->ExpectTag(74)) goto parse_ansUpdate;
        break;
      }
...
void GAnsProtocol::MergeFrom(const GAnsProtocol& from) {
  ...
  if (from._has_bits_[8 / 32] & (0xffu << (8 % 32))) {
    if (from.has_ansupdate()) {
      mutable_ansupdate()->::GAnsUserUpdate::MergeFrom(from.ansupdate());
    }
  }
}
...
bool GAnsProtocol::IsInitialized() const {
  ...
  if (has_ansupdate()) {
    if (!this->ansupdate().IsInitialized()) return false;
  }
  return true;
}
...
void GAnsProtocol::Swap(GAnsProtocol* other) {
  if (other != this) {
    ...
    std::swap(ansupdate_, other->ansupdate_);
    std::swap(_has_bits_[0], other->_has_bits_[0]);
    std::swap(_cached_size_, other->_cached_size_);
  }
}
