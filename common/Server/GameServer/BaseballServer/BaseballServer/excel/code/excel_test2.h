	...
	:Sys__T_Base
{
	...
	EBuildTypeTest m_enum_val_e; // enum_val min_max(,EBuildTypeTest)
	/*  건물을 다운시킬 때 인구가 반환됨. 인구 100% 반환되며 민가 최대 인구수 만큼만 반환됨. */
	int16 m_populationreturn4_i16; // populationreturn4 min_max(,)
	EBuildTypeTest m_test4_e; // test4 min_max(,EBuildTypeTest)
	/*  징수 명령 */
	int16 m_getgold4_i16; // getgold4 min_max(,)
	...
	jItemObj1 m_itemObj1_o; // 사용자자료형 min_max(,)
	int32 m_val_int_i32; // int변수 min_max(0,60000)
...
extern OUT nMech::nUtil::jCSV_File<Sys_T_Test4> g_Sys_T_Test4;
