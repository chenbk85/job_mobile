...
#define for_each_nEXCEL_excel_baseball_table_animation_ENUM(ENUM_TABLE)\
	...
	#define for_each_nEXCEL_EBatterAnimationType_ENUM_FIELD(ENUM_FIELD)\
		...
		ENUM_FIELD(EBAT_WINLOSE			,10,게임결과창에서 이기거나 졌을 때,nMech,nEXCEL,EBatterAnimationType)\
		ENUM_FIELD(EBAT_MENUUI			,11,MENU UI에서 포즈,nMech,nEXCEL,EBatterAnimationType)\
	...
	#define for_each_nEXCEL_EPitcherAnimationType_ENUM_FIELD(ENUM_FIELD)\
		...
		ENUM_FIELD(EPAT_WINLOSE			,9,게임결과창에서 이기거나 졌을 때,nMech,nEXCEL,EPitcherAnimationType)\
		ENUM_FIELD(EPAT_MENUUI			,10,MENU UI에서 포즈,nMech,nEXCEL,EPitcherAnimationType)\
...
namespace nMech { namespace nEXCEL 
{
	...
	enum EBatterAnimationType // 설명없음
	{
		...
		eEBAT_MAUVAIS = 9, // 헛스윙
		/* 게임결과창에서 이기거나 졌을 때 */
		eEBAT_WINLOSE = 10, // 게임결과창에서 이기거나 졌을 때
		/* MENU UI에서 포즈 */
		eEBAT_MENUUI = 11, // MENU UI에서 포즈
	...
	enum EPitcherAnimationType // 설명없음
	{
		...
		/* 게임결과창에서 이기거나 졌을 때 */
		eEPAT_WINLOSE = 9, // 게임결과창에서 이기거나 졌을 때
		/* MENU UI에서 포즈 */
		eEPAT_MENUUI = 10, // MENU UI에서 포즈
