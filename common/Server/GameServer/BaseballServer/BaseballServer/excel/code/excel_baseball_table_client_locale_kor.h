...
#ifndef __namespace_nEXCEL___filename_excel_baseball_table_client_locale_kor_
#define __namespace_nEXCEL___filename_excel_baseball_table_client_locale_kor_

#include "table_const_excel_baseball_table_client_locale_kor.h"
// -------------------------------------------------
// struct 코드 템플릿 정의
// -------------------------------------------------
#define for_each_nEXCEL_excel_baseball_table_client_locale_kor_Sys_STRUCT_LIST(STRUCT)\
...
struct jEXCEL_LIB_API Sys_Dialog_Kor /* 대화용 스트링테이블 한글 */
{
	...
	aname1024_t m_image_type; // npc그림종류 min_max(,)
	/*  대화 상황 종류 */
...
struct jEXCEL_LIB_API Sys_String_Kor /* 스트링테이블 한글 */
{
	...
	/*  영문닉네임 , 각종테이블에서 사용 */
	aname1024_t m_name; // name min_max(,)
	/*  출력되는 한글명 */
...
extern jEXCEL_LIB_API CSV_Sys_String_Kor g_Sys_String_Kor;
	...
	for_each_nEXCEL_excel_baseball_table_client_locale_kor_Sys_STRUCT_LIST(jEXCEL_TABLE_COMMON_CODE_H_Sys);
	...
	namespace nExcelUtil{
		using namespace nMech::nEXCEL;
			...
			for_each_nEXCEL_excel_baseball_table_client_locale_kor_Sys_STRUCT_LIST(jEXCEL_struct_header_default_function);
	...
	using namespace nMech::nEXCEL;
	for_each_nEXCEL_excel_baseball_table_client_locale_kor_Sys_STRUCT_LIST(jEXCEL_SQ_DECLARE_INSTANCE_TYPE);

#endif //jNOT_USE_SQ_BIND_CODE



#endif //__namespace_nEXCEL___filename_excel_baseball_table_client_locale_kor_
