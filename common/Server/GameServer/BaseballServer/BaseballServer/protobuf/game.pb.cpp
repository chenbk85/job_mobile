...
#ifndef _MSC_VER
const int GReqGameEnter::kGameIDFieldNumber;
  ...
  while ((tag = input->ReadTag()) != 0) {
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 4: {
        ...
        if (input->ExpectTag(42)) goto parse_gameUserInfo;
        break;
      }
        ...
        if (::google::protobuf::internal::WireFormatLite::GetTagWireType(tag) ==
         ...
         parse_gameUserInfo:
          DO_(::google::protobuf::internal::WireFormatLite::ReadBytes(
                input, this->mutable_gameuserinfo()));
        } else {
          goto handle_uninterpreted;
        }
...
void GReqGameEnter::SerializeWithCachedSizes(
  ...
  // required int32 categoryID = 2;
  if (has_categoryid()) {
    ::google::protobuf::internal::WireFormatLite::WriteInt32(2, this->categoryid(), output);
  }
...
void GReqGameEnter::MergeFrom(const GReqGameEnter& from) {
  ...
  if (from._has_bits_[0 / 32] & (0xffu << (0 % 32))) {
    ...
    if (from.has_gameuserinfo()) {
      set_gameuserinfo(from.gameuserinfo());
    }
  }
}
