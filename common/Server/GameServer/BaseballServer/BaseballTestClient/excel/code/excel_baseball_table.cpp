...
namespace nMech {
	...
	tcstr Sys_Base_PlayerStat::Get_name()	{		return (tcstr)m_name;}
	void Sys_Base_PlayerStat::Set_name(tcstr v)
	{
	...
	tcstr Sys_PlayerLevel::Get_name()	{		return (tcstr)m_name;}
	void Sys_PlayerLevel::Set_name(tcstr v)
	{
	...
	tcstr Sys_Quest::Get_name()	{		return (tcstr)m_name;}
	void Sys_Quest::Set_name(tcstr v)
	{
	...
	tcstr Sys_Quest::Get_help()	{		return (tcstr)m_help;}
	void Sys_Quest::Set_help(tcstr v)
	{
	...
	tcstr Sys_Quest::Get_condition1()	{		return (tcstr)m_condition1;}
	void Sys_Quest::Set_condition1(tcstr v)
	{
	...
	tcstr Sys_Quest::Get_condition2()	{		return (tcstr)m_condition2;}
	void Sys_Quest::Set_condition2(tcstr v)
	{
	...
	tcstr Sys_Title::Get_name()	{		return (tcstr)m_name;}
	void Sys_Title::Set_name(tcstr v)
	{
	...
	tcstr Sys_Title::Get_help()	{		return (tcstr)m_help;}
	void Sys_Title::Set_help(tcstr v)
	{
