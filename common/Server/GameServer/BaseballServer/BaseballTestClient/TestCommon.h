...
#define BaseballServer_jNOTUSE_SQ_CODE
...
// 서버간 공유 시작 해더
//--------------------------------------------------------------------------
#define PT_BaseballServer_LIB_API 
#define jxDECL_BaseballServer jxDECL_NET
#define jxDEFINE_BaseballServer jxDEFINE_NET
