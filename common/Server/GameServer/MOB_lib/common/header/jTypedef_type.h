...
#define js_sprintf(pBody,...) jt_sprintf_s(pBody,_countof(pBody),__VA_ARGS__)
...
#define jt_vsnprintf vsnwprintf 
...
#else
#define jt_strnicmp strncasecmp
#endif
#define jt_strftime strftime
#define jt_vsnprintf vsnprintf  
...
#else
#define ja_strnicmp strncasecmp
#endif
