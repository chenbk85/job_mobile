...
public class GuiEventManager_rps : nNWM.nGui.jGuiEventManager
{
	...
	protected void OnLoadStageXML_rps(nNWM.nXML.jxDocument stageXml)
	{
...
}//public class GuiEventManager_rps
