...
namespace nEXCEL
{
	public class excel_baseball_table_item_proto_helper
	{
			//------------------------------------------------
			//	s_sys__itembase
			//------------------------------------------------
			public static byte[] Serialize(s_sys__itembase m) 
			{
				byte[] b = null;
			...
			public static void Deserialize(ref s_sys__itembase m, byte[] serializationBytes)
			{
				using (var ms = new MemoryStream(serializationBytes))
				{
					BaseballClient_proto_Serializer psz = new BaseballClient_proto_Serializer();
					m = psz.Deserialize(ms, null, typeof(s_sys__itembase)) as s_sys__itembase;
				}
			}
			public static void Decoding_FromSocketData(ref s_sys__itembase m, byte[] socketData)
			{
				int iSize = 0;
			...
			//	s_sys_itemequip
			//------------------------------------------------
			public static byte[] Serialize(s_sys_itemequip m) 
			{
				byte[] b = null;
				using (var ms = new MemoryStream())
				{
			...
			public static void Deserialize(ref s_sys_itemequip m, byte[] serializationBytes)
			{
				using (var ms = new MemoryStream(serializationBytes))
				{
					BaseballClient_proto_Serializer psz = new BaseballClient_proto_Serializer();
					m = psz.Deserialize(ms, null, typeof(s_sys_itemequip)) as s_sys_itemequip;
				}
			}
			public static void Decoding_FromSocketData(ref s_sys_itemequip m, byte[] socketData)
			{
				int iSize = 0;
				byte[] recvData = util.DecodingSize_From_Data(ref iSize, socketData);
				Deserialize(ref m, recvData);
			...
			//	s_sys_itemstuff
			//------------------------------------------------
			public static byte[] Serialize(s_sys_itemstuff m) 
			{
				byte[] b = null;
				using (var ms = new MemoryStream())
				{
			...
			public static void Deserialize(ref s_sys_itemstuff m, byte[] serializationBytes)
			{
				using (var ms = new MemoryStream(serializationBytes))
				{
					BaseballClient_proto_Serializer psz = new BaseballClient_proto_Serializer();
					m = psz.Deserialize(ms, null, typeof(s_sys_itemstuff)) as s_sys_itemstuff;
				}
			}
			public static void Decoding_FromSocketData(ref s_sys_itemstuff m, byte[] socketData)
			{
				int iSize = 0;
				byte[] recvData = util.DecodingSize_From_Data(ref iSize, socketData);
				Deserialize(ref m, recvData);
			...
			//	s_sys_itemconsume
			//------------------------------------------------
			public static byte[] Serialize(s_sys_itemconsume m) 
			{
				byte[] b = null;
				using (var ms = new MemoryStream())
				{
			...
			public static void Deserialize(ref s_sys_itemconsume m, byte[] serializationBytes)
			{
				using (var ms = new MemoryStream(serializationBytes))
				{
					BaseballClient_proto_Serializer psz = new BaseballClient_proto_Serializer();
					m = psz.Deserialize(ms, null, typeof(s_sys_itemconsume)) as s_sys_itemconsume;
				}
			}
			public static void Decoding_FromSocketData(ref s_sys_itemconsume m, byte[] socketData)
			{
				int iSize = 0;
				byte[] recvData = util.DecodingSize_From_Data(ref iSize, socketData);
				Deserialize(ref m, recvData);
	...
	}//class excel_baseball_table_item_proto_helper
}// namespace nEXCEL
