...
namespace nEXCEL
{
	...
	public class s_sys_dialog_usa
	{
		...
		public string m_image_type {get; set;}	// [] aname32_t 
		[ProtoMember(4, IsRequired = false)]
		public int m_situation {get; set;}	// [대화 상황 종류] ENpcSituationString 
		[ProtoMember(5, IsRequired = false)]
		public string m_text {get; set;}	// [출력되는 영문 대화] aname1024_t 
	}//public class s_sys_dialog_usa
	...
	public class s_sys_string_usa
	{
		...
		[ProtoMember(3, IsRequired = false)]
		public string m_name {get; set;}	// [영문닉네임 , 각종테이블에서 사용] aname32_t 
		[ProtoMember(4, IsRequired = false)]
		public string m_text1 {get; set;}	// [출력되는 영문명] aname1024_t 
		[ProtoMember(5, IsRequired = false)]
		public string m_text2 {get; set;}	// [출력되는 영문명의 설명 a] aname1024_t 
		[ProtoMember(6, IsRequired = false)]
		public string m_text3 {get; set;}	// [출력되는 영문명의 설명 b] aname1024_t 
	}//public class s_sys_string_usa
	...
	public class excel_baseball_table_client_locale_proto_contract
	{
		public static ArrayList GetTypes()
		{
			...
			list.Add(typeof(s_sys_dialog_usa));
			list.Add(typeof(s_sys_string_kor));
			list.Add(typeof(s_sys_string_usa));
			return list;
		}
	}
}// namespace nEXCEL
