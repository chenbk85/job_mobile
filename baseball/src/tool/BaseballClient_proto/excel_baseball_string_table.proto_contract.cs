...
namespace nEXCEL
{
	...
	[ProtoContract]
	public class s_sys_error
	{
		[ProtoMember(1, IsRequired = false)]
		public Sys_Error_id_t m_id {get; set;}	// [] Sys_Error_id_t 
		[ProtoMember(2, IsRequired = false)]
		public string m_name {get; set;}	// [] aname256_t 
	...
	public class excel_baseball_string_table_proto_contract
	{
		public static ArrayList GetTypes()
		{
			ArrayList list = new ArrayList();
			
			list.Add(typeof(s_sys_error));
			return list;
		}
	}
}// namespace nEXCEL
