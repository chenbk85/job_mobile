...
#define for_each_nEXCEL_excel_baseball_table_Sys_STRUCT_LIST(STRUCT)\
	...
	#define for_each_nEXCEL_Sys_Quest_STRUCT_FIELD(FIELD)\
		...
		FIELD(name                   ,퀘스트이름              ,aname32_t                    ,1 , acstr , acstr , a32)\
		...
		FIELD(help                   ,조건설명               ,aname1024_t                  ,6 , acstr , acstr , a1024)\
		FIELD(condition_type1        ,조건1타입              ,EQuestConditionType          ,7 , EQuestConditionType , EQuestConditionType , e)\
		FIELD(condition1             ,조건1내용              ,aname1024_t                  ,8 , acstr , acstr , a1024)\
		...
		FIELD(condition2             ,조건2내용              ,aname1024_t                  ,11 , acstr , acstr , a1024)\
		FIELD(condition_value2       ,조건2값               ,int32                        ,12 , int32 , int32 , i32)\
		FIELD(condition_type3        ,조건3타입              ,EQuestConditionType          ,13 , EQuestConditionType , EQuestConditionType , e)\
		FIELD(condition3             ,조건3내용              ,aname1024_t                  ,14 , acstr , acstr , a1024)\
		FIELD(condition_value3       ,조건3값               ,int32                        ,15 , int32 , int32 , i32)\
		FIELD(quest_reward_item1     ,보상 아이템 1           ,EItemCategory                ,16 , EItemCategory , EItemCategory , e)\
		FIELD(quest_reward_item_grade1,보상 아이템 1 등급       ,EItemGradeType               ,17 , EItemGradeType , EItemGradeType , e)\
		FIELD(quest_reward_percent1  ,보상 아이템1 확률         ,int16                        ,18 , int16 , int16 , i16)\
		FIELD(quest_reward_item2     ,보상 아이템 2           ,EItemCategory                ,19 , EItemCategory , EItemCategory , e)\
		FIELD(quest_reward_item_grade2,보상 아이템 2 등급       ,EItemGradeType               ,20 , EItemGradeType , EItemGradeType , e)\
		FIELD(quest_reward_percent2  ,보상 아이템2 확률         ,int16                        ,21 , int16 , int16 , i16)\
	...
	#define for_each_nEXCEL_Sys_Title_STRUCT_FIELD(FIELD)\
		...
		FIELD(name                   ,칭호이름               ,aname32_t                    ,1 , acstr , acstr , a32)\
		...
		FIELD(help                   ,설명                 ,aname256_t                   ,4 , acstr , acstr , a256)\
...
struct jEXCEL_LIB_API Sys_Quest /* 설명없음 */
{
	...
	aname32_t m_name; // 퀘스트이름 min_max(,)
	...
	/*  출력용이아니라 개발시 참조용 */
	aname1024_t m_help; // 조건설명 min_max(,)
	EQuestConditionType m_condition_type1; // 조건1타입 min_max(,EQuestConditionType)
	/*  없을 경우 NULL */
	aname1024_t m_condition1; // 조건1내용 min_max(,)
	int32 m_condition_value1; // 조건1값 min_max(,)
	EQuestConditionType m_condition_type2; // 조건2타입 min_max(,EQuestConditionType)
	aname1024_t m_condition2; // 조건2내용 min_max(,)
	int32 m_condition_value2; // 조건2값 min_max(,)
	EQuestConditionType m_condition_type3; // 조건3타입 min_max(,EQuestConditionType)
	aname1024_t m_condition3; // 조건3내용 min_max(,)
	int32 m_condition_value3; // 조건3값 min_max(,)
	/*  보상 아이템 1 종류 */
