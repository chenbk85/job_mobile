...
#define jPREPARE_PACKET_UG2X(sd, PACKET)\
	sendMsg.set_type(UserGateServer_Client_Type_##PACKET);\
	s_##PACKET* sd = sendMsg.mutable_m_##PACKET();\

#define jMAKE_PACKET_UG2X(sendMsg,sd, PACKET)\
