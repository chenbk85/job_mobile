...
template <class Protocol_>
::boost::shared_ptr< ::apache::thrift::TProcessor > SharedServiceProcessorFactoryT<Protocol_>::getProcessor(const ::apache::thrift::TConnectionInfo& connInfo) {
  ...
  ::boost::shared_ptr< ::apache::thrift::TProcessor > processor(new SharedServiceProcessorT<Protocol_>(handler));
  return processor;
}
} // namespace
