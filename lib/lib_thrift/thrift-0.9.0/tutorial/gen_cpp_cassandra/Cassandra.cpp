    ...
    switch (fid)
    {
      ...
      case 2:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->compression = (Compression::type)ecast316;
          isset_compression = true;
        } else {
          xfer += iprot->skip(ftype);
        }
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->values.resize(_size317);
            uint32_t _i321;
            for (_i321 = 0; _i321 < _size317; ++_i321)
            {
              xfer += iprot->readString(this->values[_i321]);
            }
            xfer += iprot->readListEnd();
          }
          isset_values = true;
...
uint32_t Cassandra_execute_prepared_cql_query_args::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("values", ::apache::thrift::protocol::T_LIST, 2);
  {
    ...
    for (_iter322 = this->values.begin(); _iter322 != this->values.end(); ++_iter322)
    {
...
uint32_t Cassandra_execute_prepared_cql_query_pargs::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("values", ::apache::thrift::protocol::T_LIST, 2);
  {
    ...
    for (_iter323 = (*(this->values)).begin(); _iter323 != (*(this->values)).end(); ++_iter323)
    {
