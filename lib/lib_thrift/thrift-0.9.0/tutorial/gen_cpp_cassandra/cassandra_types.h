...
typedef struct _CfDef__isset {
  _CfDef__isset() : column_type(true), comparator_type(true), subcomparator_type(false), comment(false), read_repair_chance(true), column_metadata(false), gc_grace_seconds(false), default_validation_class(false), id(false), min_compaction_threshold(false), max_compaction_threshold(false), replicate_on_write(false), merge_shards_chance(false), key_validation_class(false), key_alias(false), compaction_strategy(false), compaction_strategy_options(false), compression_options(false), bloom_filter_fp_chance(false) {}
  bool column_type;
...
class CfDef {
 public:
  ...
  static const char* ascii_fingerprint; // = "35F896AAAE52DC7C7B1097B6DD2F7A9A";
  static const uint8_t binary_fingerprint[16]; // = {0x35,0xF8,0x96,0xAA,0xAE,0x52,0xDC,0x7C,0x7B,0x10,0x97,0xB6,0xDD,0x2F,0x7A,0x9A};

  CfDef() : keyspace(), name(), column_type("Standard"), comparator_type("BytesType"), subcomparator_type(), comment(), read_repair_chance(1), gc_grace_seconds(0), default_validation_class(), id(0), min_compaction_threshold(0), max_compaction_threshold(0), replicate_on_write(0), merge_shards_chance(0), key_validation_class(), key_alias(), compaction_strategy(), bloom_filter_fp_chance(0) {
  }
...
class KsDef {
 public:
  ...
  static const char* ascii_fingerprint; // = "3BCA17AE78739A2A9F615A4DDA8004E1";
  static const uint8_t binary_fingerprint[16]; // = {0x3B,0xCA,0x17,0xAE,0x78,0x73,0x9A,0x2A,0x9F,0x61,0x5A,0x4D,0xDA,0x80,0x04,0xE1};
