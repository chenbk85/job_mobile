    ...
    [System.Serializable, ProtoBuf.ProtoContract(Name=@"AddressBook")]
    
    public partial class AddressBook : ProtoBuf.IExtensible
    
    {
      public AddressBook() {}
      
      
    private readonly System.Collections.Generic.List<tutorial.Person> _person = new System.Collections.Generic.List<tutorial.Person>();

    [ProtoBuf.ProtoMember(1, Name=@"person", DataFormat = ProtoBuf.DataFormat.Default)]
    
    public System.Collections.Generic.List<tutorial.Person> person
    {
      get { return _person; }
