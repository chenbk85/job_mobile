...
void CXTPVisualStudio2008Theme::AlpaPixel(CDC* pDC, int x, int y, COLORREF clr, int nAlpha)
{
	if (nAlpha == 255)
	{
...
void CXTPVisualStudio2008Theme::DrawRectangle(CDC* pDC, CRect rc, BOOL bSelected, BOOL bPressed, BOOL bEnabled, BOOL bChecked, BOOL bPopuped, XTPBarType barType, XTPBarPosition barPosition)
{
	if (barPosition == xtpBarPopup && barType == xtpBarTypePopup && bSelected && !bChecked && !bPressed)
	{
		...
		AlpaPixel(pDC, rc.left + 1, rc.top + 1, clrBorder, 255);
		AlpaPixel(pDC, rc.left + 1, rc.top, clrBorder, 60);
		AlpaPixel(pDC, rc.left + 2, rc.top, clrBorder, 120);
		AlpaPixel(pDC, rc.left, rc.top + 1, clrBorder, 60);
		AlpaPixel(pDC, rc.left, rc.top + 2, clrBorder, 120);

		AlpaPixel(pDC, rc.right - 2, rc.top + 1, clrBorder, 255);
		AlpaPixel(pDC, rc.right - 3, rc.top, clrBorder, 120);
		AlpaPixel(pDC, rc.right - 2, rc.top, clrBorder, 60);
		AlpaPixel(pDC, rc.right - 1, rc.top + 1, clrBorder, 60);
		AlpaPixel(pDC, rc.right - 1, rc.top + 2, clrBorder, 120);

		AlpaPixel(pDC, rc.left + 1, rc.bottom - 2, clrBorder, 255);
		AlpaPixel(pDC, rc.left + 1, rc.bottom - 1, clrBorder, 60);
		AlpaPixel(pDC, rc.left + 2, rc.bottom - 1, clrBorder, 120);
		AlpaPixel(pDC, rc.left, rc.bottom - 2, clrBorder, 60);
		AlpaPixel(pDC, rc.left, rc.bottom - 3, clrBorder, 120);


		AlpaPixel(pDC, rc.right - 2, rc.bottom - 2, clrBorder, 255);
		AlpaPixel(pDC, rc.right - 3, rc.bottom - 1, clrBorder, 120);
		AlpaPixel(pDC, rc.right - 2, rc.bottom - 1, clrBorder, 60);
		AlpaPixel(pDC, rc.right - 1, rc.bottom - 2, clrBorder, 60);
		AlpaPixel(pDC, rc.right - 1, rc.bottom - 3, clrBorder, 120);
		return;
	}
