...
//{{AFX_CODEJOCK_PRIVATE
	...
	virtual CRect CalcFrameBorders(DWORD dwStyle, DWORD dwExStyle) = 0;
...
private:
	...
	static void AFX_CDECL RegionFromBitmap(CDC* pDC, CRgn* pRgnLeft, CRgn* pRgnRight, int& nRgnFrameCenter, const CRect& rc, const CRect& rcSizingMargins, COLORREF clrTransparent);
