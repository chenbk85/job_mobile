...
void CXTPTabPaintManager::CAppearanceSetPropertyPage2007::DrawSingleButton(CDC* pDC, CXTPTabManagerItem* pItem)
{
	...
	if (pItem->IsSelected() || pItem->IsHighlighted())
	{
		switch (pItem->GetTabManager()->GetPosition())
		{
			...
			case xtpTabPositionBottom:
				DrawRotatedButton(pDC, rc, pItem, FALSE, NULL, &CColorSetWinXP::DrawRotatedBitsBottom);
				break;

			case xtpTabPositionLeft:
				DrawRotatedButton(pDC, rc, pItem, TRUE, NULL, &CColorSetWinXP::DrawRotatedBitsLeft);
				break;

			case xtpTabPositionRight:
				DrawRotatedButton(pDC, rc, pItem, TRUE, NULL, &CColorSetWinXP::DrawRotatedBitsRight);
				break;
		}
...
{
	CXTPOffice2007Image* pImage = XTPOffice2007Images()->LoadFile(_T("ACCESSTAB"));
...
void CXTPTabPaintManager::CAppearanceSetPropertyPageAccess2007::DrawSingleButton(CDC* pDC, CXTPTabManagerItem* pItem)
{
	...
	case xtpTabPositionBottom:
		DrawRotatedButton(pDC, rc, pItem, FALSE, &CColorSetWinXP::DrawRotatedBitsBottom, &CColorSetWinXP::DrawRotatedBitsBottom);
		break;

	case xtpTabPositionLeft:
		DrawRotatedButton(pDC, rc, pItem, TRUE, &CColorSetWinXP::DrawRotatedBitsLeft, &CColorSetWinXP::DrawRotatedBitsLeft);
		break;

	case xtpTabPositionRight:
		DrawRotatedButton(pDC, rc, pItem, TRUE, &CColorSetWinXP::DrawRotatedBitsInvertRight, &CColorSetWinXP::DrawRotatedBitsRight);
		break;
	}
