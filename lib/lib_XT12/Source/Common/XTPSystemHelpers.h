...
public:
	...
	// *_* by icandoit : 2009-11-18 17:14:41
	//
#if 1
...
#else
	virtual HRESULT CXTPAccessible::GetAccessibleParent(IDispatch**  /*ppdispParent*/)
	{
		return E_NOTIMPL;
	}
	virtual HRESULT CXTPAccessible::GetAccessibleChildCount(long* /*pcountChildren*/)
	{
		return E_NOTIMPL;
	}
	virtual HRESULT CXTPAccessible::GetAccessibleChild(VARIANT /*varChild*/, IDispatch** /*ppdispChild*/)
	{
		return E_NOTIMPL;
	}
	virtual HRESULT CXTPAccessible::GetAccessibleName(VARIANT /*varChild*/, BSTR* /*pszName*/)
	{
		return E_NOTIMPL;
	}
	virtual HRESULT CXTPAccessible::GetAccessibleValue(VARIANT /*varChild*/, BSTR* /*pszValue*/)
	{
		return E_NOTIMPL;
	}
	virtual HRESULT CXTPAccessible::GetAccessibleDescription(VARIANT /*varChild*/, BSTR* /*pszDescription*/)
	{
		return E_NOTIMPL;
	}
	virtual HRESULT CXTPAccessible::GetAccessibleRole(VARIANT /*varChild*/, VARIANT* /*pvarRole*/)
	{
		return E_NOTIMPL;
	}
	virtual HRESULT CXTPAccessible::GetAccessibleState(VARIANT /*varChild*/, VARIANT* /*pvarState*/)
	{
		return E_NOTIMPL;
	}
	virtual HRESULT CXTPAccessible::GetAccessibleHelp(VARIANT /*varChild*/, BSTR* /*pszHelp*/)
	{
		return E_NOTIMPL;
	}
	virtual HRESULT CXTPAccessible::GetAccessibleHelpTopic(BSTR* /*pszHelpFile*/, VARIANT /*varChild*/, long* /*pidTopic*/)
	{
		return E_NOTIMPL;
	}
	virtual HRESULT CXTPAccessible::GetAccessibleKeyboardShortcut(VARIANT /*varChild*/, BSTR* /*pszKeyboardShortcut*/)
	{
		return E_NOTIMPL;
	}
	virtual HRESULT CXTPAccessible::GetAccessibleFocus(VARIANT* /*pvarChild*/)
	{
		return S_FALSE;
	}
	virtual HRESULT CXTPAccessible::GetAccessibleSelection(VARIANT* /*pvarChildren*/)
	{
		return S_FALSE;
	}
	virtual HRESULT CXTPAccessible::GetAccessibleDefaultAction(VARIANT /*varChild*/, BSTR* /*pszDefaultAction*/)
	{
		return E_NOTIMPL;
	}
	virtual HRESULT CXTPAccessible::AccessibleSelect(long /*flagsSelect*/, VARIANT /*varChild*/)
	{
		return E_NOTIMPL;
	}
	virtual HRESULT CXTPAccessible::AccessibleLocation(long* /*pxLeft*/, long* /*pyTop*/, long* /*pcxWidth*/, long* /*pcyHeight*/, VARIANT /*varChild*/)
	{
		return E_NOTIMPL;
	}
	virtual HRESULT CXTPAccessible::AccessibleNavigate(long /*navDir*/, VARIANT /*varStart*/, VARIANT* /*pvarEndUpAt*/)
	{
		return E_NOTIMPL;
	}
	virtual HRESULT CXTPAccessible::AccessibleHitTest(long /*xLeft*/, long /*yTop*/, VARIANT* /*pvarChild*/)
	{
		return E_NOTIMPL;
	}
	virtual HRESULT CXTPAccessible::AccessibleDoDefaultAction(VARIANT /*varChild*/)
	{
		return E_NOTIMPL;
	}
	virtual HRESULT CXTPAccessible::PutAccessibleName(VARIANT /*varChild*/, BSTR /*szName*/)
	{
		return E_NOTIMPL;
	}
	virtual HRESULT CXTPAccessible::PutAccessibleValue(VARIANT /*varChild*/, BSTR /*szValue*/)
	{
		return E_NOTIMPL;
	}
	virtual CCmdTarget* CXTPAccessible::GetAccessible()
	{
		ASSERT(FALSE);
		return NULL;
	}
#endif
	// *_* by icandoit : 2009-11-18 17:14:55
	//
