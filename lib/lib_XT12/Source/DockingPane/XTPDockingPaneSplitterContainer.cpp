...
void CXTPDockingPaneSplitterWnd::Reposition(CRect rc, CRect rcAvail)
{
	...
	int nSplitterIndent = m_pContainer->GetDockingPaneManager()->GetPaintManager()->m_nSplitterIndent;
...
void CXTPDockingPaneSplitterContainer::OnSizeParent(CWnd* pParent, CRect rect, LPVOID lParam)
{
	...
	int nSplitterIndent = GetDockingPaneManager()->GetPaintManager()->m_nSplitterIndent;
