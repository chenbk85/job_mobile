...
COLORREF CXTPDockingPaneOfficeTheme::FillCaptionPart(CDC* pDC, CXTPDockingPaneBase* pPane, CRect rcCaption, BOOL bActive, BOOL bVertical)
{
...
void CXTPDockingPaneOfficeTheme::DrawCaptionPart(CDC* pDC, CXTPDockingPaneBase* pPane, CRect rcCaption, const CString& strTitle, BOOL bActive, BOOL bVertical)
{
	...
	DrawCaptionButtons(pDC, pPane->GetCaptionButtons(), rcCaption, clrButton, 14, 2, bVertical);
...
void CXTPDockingPaneExplorerTheme::DrawCaptionPart(CDC* pDC, CXTPDockingPaneBase* pPane, CRect rcCaption, const CString& strTitle, BOOL bActive, BOOL bVertical)
{
...
void CXTPDockingPaneVisioTheme::DrawPane(CDC* pDC, CXTPDockingPaneTabbedContainer* pPane, CRect rc)
{
	BOOL bActive = m_bHighlightActiveCaption && pPane->IsActive();
...
void CXTPDockingPaneVisioTheme::DrawFloatingFrame(CDC* pDC, CXTPDockingPaneMiniWnd* pPane, CRect rc)
{
	BOOL bActive = m_bHighlightActiveCaption && pPane->IsActive();
...
void CXTPDockingPaneVisioTheme::DrawCaption(CDC* pDC, CXTPDockingPaneTabbedContainer* pPane, CRect rc)
{
	BOOL bVertical = pPane->IsCaptionVertical();
	BOOL bActive = m_bHighlightActiveCaption && pPane->IsActive();
	int nTitleHeight = m_nTitleHeight;
...
CXTPDockingPaneWord2007Theme::CXTPDockingPaneWord2007Theme()
{
	m_bRoundedCaption = FALSE;
	m_dwSplitterStyle = xtpPaneSplitterFlat;
	m_bDrawGripper = FALSE;
...
void CXTPDockingPaneWord2007Theme::DrawCaption(CDC* pDC, CXTPDockingPaneTabbedContainer* pPane, CRect rc)
{
	BOOL bVertical = pPane->IsCaptionVertical();
...
void CXTPDockingPaneWord2007Theme::DrawCaptionPart(CDC* pDC, CXTPDockingPaneBase* pPane, CRect rcCaption, const CString& strTitle, BOOL bActive, BOOL bVertical)
{
	COLORREF clrText = bActive ? m_clrActiveCaptionText : m_clrNormalCaptionText;
...
BOOL CXTPDockingPaneWord2007Theme::PaneHasBorders(CXTPDockingPaneTabbedContainer* pPane) const
{
	return pPane->IsTitleVisible();
}

void CXTPDockingPaneWord2007Theme::AdjustClientRect(CXTPDockingPaneTabbedContainer* pPane, CRect& rect, BOOL bApply)
{
...
void CXTPDockingPaneWord2007Theme::DrawPane(CDC* pDC, CXTPDockingPaneTabbedContainer* pPane, CRect rc)
{
	if (PaneHasBorders(pPane))
	{
...
void CXTPDockingPaneWord2007Theme::RefreshMetrics()
{
	CXTPDockingPaneOffice2003Theme::RefreshMetrics();

	m_arrColor[XPCOLOR_FRAME] = XTPOffice2007Images()->GetImageColor(_T("DockingPane"), _T("WordSplitter"));
	m_arrColor[XPCOLOR_3DFACE] = XTPOffice2007Images()->GetImageColor(_T("DockingPane"), _T("WordPaneBackground"));
	m_arrColor[COLOR_3DHIGHLIGHT] = XTPOffice2007Images()->GetImageColor(_T("Window"), _T("EdgeHighLightColor"));


	m_arrColor[XPCOLOR_TOOLBAR_GRIPPER] = XTPOffice2007Images()->GetImageColor(_T("DockingPane"), _T("WordPaneBorder"));
	m_arrColor[XPCOLOR_MENUBAR_BORDER] = XTPOffice2007Images()->GetImageColor(_T("DockingPane"), _T("WordSplitter"));

	m_arrColor[XPCOLOR_HIGHLIGHT_BORDER] = XTPOffice2007Images()->GetImageColor(_T("Window"), _T("HighlightSelectedBorder"));
	m_arrColor[XPCOLOR_HIGHLIGHT] = XTPOffice2007Images()->GetImageColor(_T("Window"), _T("HighlightSelected"));
	m_arrColor[XPCOLOR_HIGHLIGHT_PUSHED_BORDER] = XTPOffice2007Images()->GetImageColor(_T("Window"), _T("HighlightPressedBorder"));
	m_arrColor[XPCOLOR_HIGHLIGHT_PUSHED] = XTPOffice2007Images()->GetImageColor(_T("Window"), _T("HighlightPressed"));
	m_arrColor[XPCOLOR_HIGHLIGHT_TEXT] = 0;
	m_arrColor[XPCOLOR_PUSHED_TEXT] = 0;

	m_bLunaTheme = FALSE;

	m_clrSplitterGradient.SetStandardValue(XTPOffice2007Images()->GetImageColor(_T("DockingPane"), _T("WordSplitter")));
	m_clrSplitter.SetStandardValue(m_clrSplitterGradient);

	m_clrNormalCaption.SetStandardValue(XTPOffice2007Images()->GetImageColor(_T("DockingPane"), _T("WordNormalCaption")));
	m_clrNormalCaptionText.SetStandardValue(XTPOffice2007Images()->GetImageColor(_T("DockingPane"), _T("WordCaptionText")));

	m_clrActiveCaption.SetStandardValue(XTPOffice2007Images()->GetImageColor(_T("DockingPane"), _T("WordActiveCaption")));
	m_clrActiveCaptionText.SetStandardValue(XTPOffice2007Images()->GetImageColor(_T("DockingPane"), _T("WordCaptionText")));
...
void CXTPDockingPaneNativeXPTheme::DrawFloatingFrame(CDC* pDC, CXTPDockingPaneMiniWnd* pPane, CRect rc)
{
	if (!m_themeWindow.IsAppThemed())
	{
		CXTPDockingPaneOfficeTheme::DrawFloatingFrame(pDC, pPane, rc);
		return;
	}
	BOOL bActive = m_bHighlightActiveCaption && pPane->IsActive();
...
void CXTPDockingPaneNativeXPTheme::DrawSidePanel(CDC* pDC, CXTPDockingPaneSidePanel* pPane, CRect rc)
{
	CXTPDockingPaneOfficeTheme::DrawSidePanel(pDC, pPane, rc);
}

void CXTPDockingPaneNativeXPTheme::DrawCaptionPart(CDC* pDC, CXTPDockingPaneBase* pPane, CRect rcCaption, const CString& strTitle, BOOL bActive, BOOL bVertical)
{
	if (!m_themeWindow.IsAppThemed())
	{
		CXTPDockingPaneOfficeTheme::DrawCaptionPart(pDC, pPane, rcCaption, strTitle, bActive, bVertical);
		return;
	}
...
void CXTPDockingPaneNativeXPTheme::DrawCaption(CDC* pDC, CXTPDockingPaneTabbedContainer* pPane, CRect rc)
{
	if (!m_themeWindow.IsAppThemed())
	{
		CXTPDockingPaneOfficeTheme::DrawCaption(pDC, pPane, rc);
		return;
	}
...
COLORREF CXTPDockingPaneVisualStudio2005SecondTheme::FillCaptionPart(CDC* pDC, CXTPDockingPaneBase* pPane, CRect rcCaption, BOOL bActive, BOOL bVertical)
{
	XTPDrawHelpers()->GradientFill(pDC, rcCaption, bActive ? m_clrActiveCaption : m_clrNormalCaption, bVertical);
