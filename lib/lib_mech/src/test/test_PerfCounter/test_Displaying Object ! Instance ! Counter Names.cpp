...
PPERF_OBJECT LoadObjects(LPBYTE pObject, DWORD dwNumberOfObjects);
...
void test_displaying(void)
{
	...
	g_pObjects = LoadObjects(g_pPerfDataHead + ((PERF_DATA_BLOCK*)g_pPerfDataHead)->HeaderLength, dwNumberOfObjects);
...
PPERF_OBJECT LoadObjects(LPBYTE pPerfDataObject, DWORD dwNumberOfObjects)
{
	BOOL fSuccess = FALSE;
	DWORD dwSize = sizeof(PERF_OBJECT) * dwNumberOfObjects;
	...
	qsort(pObjects, dwNumberOfObjects, sizeof(PERF_OBJECT), CompareObjects);
