...
//--------------------------------------------------------------------------
{
	...
	*/
	...
	SquirrelObject testStaticVars = GetjISQ()->VM_CompileBuffer(_T(" \
										 local v2 = Vector3(); \
										 local v3 = Vector3(); \
										 local v4 = v2+v3; \
										 v4.Print();\
										 ...
										 v2.staticVar = 0; "));
	GetjISQ()->VM_RunScript(testStaticVars);
	/* 출력
	...
	*/
	...
	SquirrelObject testConstants0 = GetjISQ()->VM_CompileBuffer(
		_T(" print(\"SQ_PI*2: \"+SQ_PI_2+\" SQ_10_2: \"+SQ_10_2+\" GLOBAL_STRING: \"+GLOBAL_STRING); "));
	GetjISQ()->VM_RunScript(testConstants0);
	...
	*/
	...
	SquirrelObject testConstants2 = GetjISQ()->VM_CompileBuffer(_T("\
			 local v = Vector3(); \
	...
	GetjISQ()->VM_RunScript(testConstants2);
	/*출력
