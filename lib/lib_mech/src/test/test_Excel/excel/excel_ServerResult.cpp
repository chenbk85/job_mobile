...
namespace nMech
{
	...
	#if defined(jEXCEL_TABLE_COMMON_CODE_CPP_SQ_GLOBAL_Sys) && defined(for_each_nEXCEL_excel_ServerResult_Sys_STRUCT_LIST)
		for_each_nEXCEL_excel_ServerResult_Sys_STRUCT_LIST(jEXCEL_TABLE_COMMON_CODE_CPP_SQ_GLOBAL_Sys);
	#endif //jEXCEL_TABLE_COMMON_CODE_CPP_SQ_GLOBAL_Sys


	#ifdef jEXCEL_TABLE_COMMON_CODE_CPP_SQ_GLOBAL_Tbl
		for_each_nEXCEL_excel_ServerResult_Tbl_STRUCT_LIST(jEXCEL_TABLE_COMMON_CODE_CPP_SQ_GLOBAL_Tbl);
...
namespace nMech {
	...
	uint32 Sys_ServerResult::Get_id()	{		return (uint32)m_id;}
	void Sys_ServerResult::Set_id(uint32 v)
	{
		m_id=v;
	}
	...
	tcstr Sys_ServerResult::Get_description()	{	return nExcelUtil::jGetter(m_description);}
	...
	for_each_nEXCEL_excel_ServerResult_Sys_STRUCT_LIST(jEXCEL_TABLE_COMMON_CODE_CPP_Sys);
...
{	tname1024_t szBuf;
	...
	for_each_nEXCEL_Sys_ServerResult_STRUCT_FIELD_all_member(jEXCEL_STRUCT_FIELD_DebugPrint);
}
	...
	{
		jSQ_REGIST_BIND(nMech_nEXCEL_excel_ServerResult)
		{
			...
			for_each_nEXCEL_Sys_ServerResult_STRUCT_FIELD(jEXCEL_SQ_TABLE_FILED_BIND);
