...
namespace nEXCEL
{
	...
	public class CSV_Sys_T_Test
	{
		...
		public		static List<Sys_T_Test>		m_List = new List<Sys_T_Test> { };
	...
	public class CSV_Sys_T_Test2
	{
		...
		public		static List<Sys_T_Test2>		m_List = new List<Sys_T_Test2> { };
		public      static void             Print()
		{
			Console.WriteLine("\n\n<<< Sys_T_Test2 >>>");
	...
	public class CSV_Sys_T_Test3
	{
		...
		public		static List<Sys_T_Test3>		m_List = new List<Sys_T_Test3> { };
		public      static void             Print()
		{
			Console.WriteLine("\n\n<<< Sys_T_Test3 >>>");
