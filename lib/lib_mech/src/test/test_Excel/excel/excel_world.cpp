...
namespace nMech
{
	...
	#if defined(jEXCEL_TABLE_COMMON_CODE_CPP_SQ_GLOBAL_Sys) && defined(for_each_nEXCEL_excel_world_Sys_STRUCT_LIST)
		for_each_nEXCEL_excel_world_Sys_STRUCT_LIST(jEXCEL_TABLE_COMMON_CODE_CPP_SQ_GLOBAL_Sys);
	#endif //jEXCEL_TABLE_COMMON_CODE_CPP_SQ_GLOBAL_Sys


	#ifdef jEXCEL_TABLE_COMMON_CODE_CPP_SQ_GLOBAL_Tbl
		for_each_nEXCEL_excel_world_Tbl_STRUCT_LIST(jEXCEL_TABLE_COMMON_CODE_CPP_SQ_GLOBAL_Tbl);
	#endif //jEXCEL_TABLE_COMMON_CODE_CPP_SQ_GLOBAL_Tbl

#endif //jNOT_USE_SQ_BIND_CODE


for_each_nEXCEL_excel_world_ENUM(jEXCEL_SQ_DECLARE_ENUM_TYPE);
namespace nMech {
	namespace nEXCEL {
...
jEXCEL_LIB_API nExcelUtil::jEnumString g_ES_EIssue_Info[] = 
{
	{ 4 , 0, 0},
		...
		for_each_nEXCEL_EIssue_Info_ENUM_FIELD(jEXCEL_ENUM_STRING_CPP_CODE)
...
jEXCEL_LIB_API nExcelUtil::jEnumString g_ES_ETile_Sort[] = 
{
	{ 7 , 0, 0},
	#ifdef jEXCEL_ENUM_STRING_CPP_CODE
		for_each_nEXCEL_ETile_Sort_ENUM_FIELD(jEXCEL_ENUM_STRING_CPP_CODE)
	#endif // jEXCEL_ENUM_STRING_CPP_CODE
};
	...
	for_each_nEXCEL_excel_world_Sys_STRUCT_LIST(jEXCEL_TABLE_COMMON_CODE_CPP_Sys);
...
{	tname1024_t szBuf;
	...
	for_each_nEXCEL_Sys_Tile_STRUCT_FIELD_all_member(jEXCEL_STRUCT_FIELD_DebugPrint);
}

void Sys_World::DebugPrint()
{	tname1024_t szBuf;

	for_each_nEXCEL_Sys_World_STRUCT_FIELD_all_member(jEXCEL_STRUCT_FIELD_DebugPrint);
}
	...
	{
		jSQ_REGIST_BIND(nMech_nEXCEL_excel_world)
		{
			{
				SquirrelObject enumRoot= nSQ::jSQ_GetEnumTable();
				for_each_nEXCEL_excel_world_ENUM(jEXCEL_SQ_bind_EnumField_BEGIN);
				for_each_nEXCEL_EIssue_Info_ENUM_FIELD(jEXCEL_SQ_bind_EnumField);
				for_each_nEXCEL_ETile_Sort_ENUM_FIELD(jEXCEL_SQ_bind_EnumField);
			}
			...
			for_each_nEXCEL_Sys_Tile_STRUCT_FIELD(jEXCEL_SQ_TABLE_FILED_BIND);
			...
			for_each_nEXCEL_Sys_World_STRUCT_FIELD(jEXCEL_SQ_TABLE_FILED_BIND);
