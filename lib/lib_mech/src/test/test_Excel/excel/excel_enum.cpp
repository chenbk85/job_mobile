...
jEXCEL_LIB_API nExcelUtil::jEnumString g_ES_EAvatarClass[] = 
{
	{ 4 , 0, 0},
		...
		for_each_nEXCEL_EAvatarClass_ENUM_FIELD(jEXCEL_ENUM_STRING_CPP_CODE)
...
jEXCEL_LIB_API nExcelUtil::jEnumString g_ES_EBuildType_test[] = 
{
	{ 22 , 0, 0},
	#ifdef jEXCEL_ENUM_STRING_CPP_CODE
		for_each_nEXCEL_EBuildType_test_ENUM_FIELD(jEXCEL_ENUM_STRING_CPP_CODE)
	#endif // jEXCEL_ENUM_STRING_CPP_CODE
};
jEXCEL_LIB_API nExcelUtil::jEnumString g_ES_EBuildTypeTest[] = 
{
	{ 22 , 0, 0},
	#ifdef jEXCEL_ENUM_STRING_CPP_CODE
		for_each_nEXCEL_EBuildTypeTest_ENUM_FIELD(jEXCEL_ENUM_STRING_CPP_CODE)
	#endif // jEXCEL_ENUM_STRING_CPP_CODE
};
jEXCEL_LIB_API nExcelUtil::jEnumString g_ES_EOutput_test[] = 
{
	{ 24 , 0, 0},
	#ifdef jEXCEL_ENUM_STRING_CPP_CODE
		for_each_nEXCEL_EOutput_test_ENUM_FIELD(jEXCEL_ENUM_STRING_CPP_CODE)
	#endif // jEXCEL_ENUM_STRING_CPP_CODE
};
		...
		{
			{
				...
				for_each_nEXCEL_EAvatarClass_ENUM_FIELD(jEXCEL_SQ_bind_EnumField);
				for_each_nEXCEL_EBuildType_test_ENUM_FIELD(jEXCEL_SQ_bind_EnumField);
				for_each_nEXCEL_EBuildTypeTest_ENUM_FIELD(jEXCEL_SQ_bind_EnumField);
				for_each_nEXCEL_EOutput_test_ENUM_FIELD(jEXCEL_SQ_bind_EnumField);
			}
		}
