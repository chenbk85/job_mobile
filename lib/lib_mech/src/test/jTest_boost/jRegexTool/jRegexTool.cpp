// jRegexTool.cpp : 응용 프로그램에 대한 클래스 동작을 정의합니다.
//
...
BEGIN_MESSAGE_MAP(CjRegexToolApp, CWinApp)
...
// 유일한 CjRegexToolApp 개체입니다.

CjRegexToolApp theApp;


// CjRegexToolApp 초기화

BOOL CjRegexToolApp::InitInstance()
{
