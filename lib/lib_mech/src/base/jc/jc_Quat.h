...
namespace nMech
{
	namespace nMath
	{
		...
		// Typedefs                                                                  // 
		///////////////////////////////////////////////////////////////////////////////
		typedef Quaternion_tpl<f32>	jcQuat;
		#ifndef MAX_API_NUM
		...
		//-------------------------------
			...
			Quaternion_tpl( const F angle, const jVec3_tpl<F> &axis);
		...
		/*	declared as static but never used or implemented as static member functions, Linux gcc don't like it too
			...
			template<typename F1,typename F2>	static jVec3_tpl<F2> operator*(const Quaternion_tpl<F1> &q, const jVec3_tpl<F2> &v);
			template<typename F1,typename F2>	static jVec3_tpl<F1> operator*(const jVec3_tpl<F1> &v, const Quaternion_tpl<F2> &q);
		#endif
		*/
			...
			void SetRotationAA(F rad, const jVec3_tpl<F> &axis);
			static Quaternion_tpl<F> GetRotationAA(F rad, const jVec3_tpl<F> &axis);

			void SetRotationAA(F cosha, F sinha, const jVec3_tpl<F> &axis);
			static Quaternion_tpl<F> GetRotationAA(F cosha, F sinha, const jVec3_tpl<F> &axis);

			void SetRotationV0V1(const jVec3_tpl<F>& v0, const jVec3_tpl<F>& v1);
			static Quaternion_tpl<F> GetRotationV0V1(const jVec3_tpl<F>& v0, const jVec3_tpl<F>& v1);
		...
		//-------------------------------------------------------------------------------
			...
			*/
			template<class F>	
			ILINE Quaternion_tpl<F>::Quaternion_tpl( const F angle, const jVec3_tpl<F> &axis) {	w=angle; v=axis; 	}
		...
		*/
		...
		/*!
		*
		* multiplication operator with a jVec3 (3D rotations with quaternions)
		* 
		* Example:
		...
		*/
		template<class F1,class F2>
		ILINE jVec3_tpl<F2> operator*(const Quaternion_tpl<F1> &q, const jVec3_tpl<F2> &v) {
		#if !defined(LINUX)
		...
		*/
		template<class F1,class F2>
		ILINE jVec3_tpl<F1> operator*(const jVec3_tpl<F1> &v, const Quaternion_tpl<F2> &q) {
		#if !defined(LINUX)
		...
		*
		* Example:
		*		Quaternion_tpl<f32> q=GetRotationAA( 2.14255f, GetNormalized(jVec3(1,2,3)) );
		*		q.SetRotationAA( 2.14255f, GetNormalized(jVec3(1,2,3)) );
		*/
		template<class F> 
		ILINE void Quaternion_tpl<F>::SetRotationAA(F rad, const jVec3_tpl<F> &axis) { F cs[2]; sincos_tpl( rad*(F)0.5, cs);	SetRotationAA(cs[0],cs[1], axis); }
		template<class F> 
		ILINE Quaternion_tpl<F> Quaternion_tpl<F>::GetRotationAA(F rad, const jVec3_tpl<F> &axis) { 	Quaternion_tpl<F> q;	q.SetRotationAA(rad,axis); 	return q;	}
		template<class F> 
		ILINE Quaternion_tpl<F> GetRotationAA(F rad, const jVec3_tpl<F> &axis) {	Quaternion_tpl<F> q;	q.SetRotationAA(rad,axis); 	return q;	}


		template<class F>ILINE void Quaternion_tpl<F>::SetRotationAA(F cosha, F sinha, const jVec3_tpl<F> &axis)	{ 
		#if !defined(LINUX)
		...
		template<class F> 
		ILINE Quaternion_tpl<F> Quaternion_tpl<F>::GetRotationAA(F cosha, F sinha, const jVec3_tpl<F> &axis) { Quaternion_tpl<F> q;	q.SetRotationAA(cosha,sinha,axis); 	return q;	}
		template<class F> 
		ILINE Quaternion_tpl<F> GetRotationAA(F cosha, F sinha, const jVec3_tpl<F> &axis) { Quaternion_tpl<F> q;	q.SetRotationAA(cosha,sinha,axis); 	return q;	}
		...
		*
		* Example:
		*		Quaternion_tpl<f32> q=GetRotationV0V1( GetNormalized(jVec3(3,1,7)), GetNormalized(jVec3(1,2,3)) );
		*		q.SetRotationV0V1( GetNormalized(jVec3(3,1,7)), GetNormalized(jVec3(1,2,3)) );
		*/
		template<class F> 
		void Quaternion_tpl<F>::SetRotationV0V1(const jVec3_tpl<F>& v0, const jVec3_tpl<F>& v1)	
		{ 
		#if !defined(LINUX)
		...
		template<class F> 
		ILINE Quaternion_tpl<F> Quaternion_tpl<F>::GetRotationV0V1(const jVec3_tpl<F>& v0, const jVec3_tpl<F>& v1) {	Quaternion_tpl<F> q;	q.SetRotationV0V1(v0,v1); 	return q;	}
		template<class F> 
		ILINE Quaternion_tpl<F> GetRotationV0V1(const jVec3_tpl<F>& v0, const jVec3_tpl<F>& v1) {	Quaternion_tpl<F> q;	q.SetRotationV0V1(v0,v1); 	return q;	}
		...
		*/
		...
		ILINE Quaternion_tpl<F>	SquadRev(	f32 angle,				// angle of rotation 
															const jVec3& axis,	// the axis of rotation 
