...
// Include crtdbg
// inlcude this file
// Use jc::vector instead of std::vector,
//     jc::string instead of string,
//     jc::set instead of std::set
//     jc::map instead of std::map
//
// In order to specify your own source of allocation, in the constructor specify one or two parameters
// like: 
//   ...
//   jc::map<int,jc::string> m_mapSomething;
//   ...
...
//   jc::string strMyString ("Your string", jc::string::_Allocator("My Source.strMyString", 0));
//
// NOTE:
//   You MUST include the map, string, vector and set in order to jc:: classes to be defined here.
///////////////////////////////////////////////////////////////////////////////////////////////////
#ifndef _JCGAME_DBG_ALLOCATOR_HDR_
#define _JCGAME_DBG_ALLOCATOR_HDR_
#include <string>
#include <set>
#include <vector>
#include <map>
...
public:
	...
	dbg_allocator<T>(const char* szParentObject = "jc_dbg_alloc", int nParentIndex = 0):
...
class dbg_allocator: public std::allocator<T>
	{
	public:
		dbg_allocator(const char* szSource = "jcDbgAlloc", int nSource = 0)
		{	// construct default allocator (do nothing)
		}
