/*=============================================================================
  ...
  Copyright (c) 2001 jGame. All Rights Reserved.
...
public:
  CFColor() {}
  CFColor(const nMech::nMath::jVec3 & vVec)
  {
    r = vVec.x;
    g = vVec.y;
    b = vVec.z;
...
/*  CFColor(jcIRGB *c)
  ...
  unsigned int GetTrue()
  {
    ...
    C.R = nMech::uchar(r * 255.0f); 
    C.G = nMech::uchar(g * 255.0f); 
    C.B = nMech::uchar(b * 255.0f); 
    C.A = nMech::uchar(a * 255.0f);
    return C.D;
  }
  ...
  unsigned int GetTrueInv()
  {
    ...
    C.R = nMech::uchar(255.0f-r*255.0f); 
    C.G = nMech::uchar(255.0f-g*255.0f); 
    C.B = nMech::uchar(255.0f-b*255.0f); 
    C.A = nMech::uchar(255.0f-a*255.0f);
    return C.D;
  }
