#ifndef _JCGAME_COMMON_TARRAYS_HDR_
#define _JCGAME_COMMON_TARRAYS_HDR_
...
namespace nMech
{
	namespace nJC
	{
		...
		// T*Array members
		// USAGE:
		//  if you have an array std::vector<jcVertex> m_arrMyArray,
		//  then Type is jcVertex, Singular is probably Vertex, Plural is probably Vertices, member is m_arrMyArray
