/* ========================================================================================== */
/* JC_GAMESOUND Main header file. Copyright (c), Firelight ES_Clientlogies Pty, Ltd 1999-2002.           */
/* ========================================================================================== */
...
[
    ...
    CS_INIT_ENABLEOUTPUTFX Is an init mode which enables the JC_GAMESOUND mixer buffer to be affected by DirectX 8 effects.
...
#define CS_INIT_PS2_SWAPDMACORES        0x40    /* PS2 only - By default JC_GAMESOUND uses DMA CH0 for mixing, CH1 for uploads, this flag swaps them around */
/* [DEFINE_END] */
...
DLL_API signed char     F_API CS_Stream_SetSubStream(CS_STREAM *stream, int index);     /* For JC_GAMESOUND .FSB bank files.  Console only currently. */
DLL_API int             F_API CS_Stream_GetNumSubStreams(CS_STREAM *stream);            /* For JC_GAMESOUND .FSB bank files.  Console only currently. */
