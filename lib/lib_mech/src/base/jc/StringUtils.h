/////////////////////////////////////////////////////////////////////////////////////////////////////
//
//	n_jGame_c Character Animation source code
//	
//	History:
...
#ifndef _JCGAME_ENGINE_STRING_UTILS_HDR_
#define _JCGAME_ENGINE_STRING_UTILS_HDR_
...
#ifdef jc_matrix_header___
			inline string toString(const nMech::nMath::Matrix44& m)
			{
				char szBuf[0x200];
...
#ifdef _JC_QUAT_H
			inline string toString (const nMech::nMath::jcQuat& q)
			{
				char szBuf[0x100];
...
#ifdef jc_vector3_header_232_h
			inline string toString (const nMech::nMath::jVec3& v)
			{
				char szBuf[0x80];
