...
#define _ISCRIPTSYSTEM_H_
	...
	#ifdef JC_GAMESCRIPTSYSTEM_EXPORTS
		#define JC_GAMESCRIPTSYSTEM_API __declspec(dllexport)
	#else
		#define JC_GAMESCRIPTSYSTEM_API __declspec(dllimport)
	#endif
#else
	#define JC_GAMESCRIPTSYSTEM_API
#endif
...
#define USER_DATA ULONG_PTR			//## AMD Port
		...
		*/
		struct IScriptSystem
		{
			...
			*/
			...
			virtual nMech::nLUA1::IScriptObject *GetGlobalObject() = 0;

			/*! create a new nMech::nLUA1::IScriptObject that is not mapped to a object in the script
			this is used to store an object that lua pass to a C++ function
			@return a pointer to the created object
			*/
			virtual nMech::nLUA1::IScriptObject* CreateEmptyObject() = 0;
			/*!	create a new nMech::nLUA1::IScriptObject 
			@return a pointer to the created object
			*/
			virtual nMech::nLUA1::IScriptObject* CreateObject() = 0;
			/*!	create a global nMech::nLUA1::IScriptObject 
			...
			@return a pointer to the created object
			*/
			virtual nMech::nLUA1::IScriptObject* CreateGlobalObject(const char *sName) = 0;
			...
			*/
			//##@{
			virtual int BeginCall(HSCRIPTFUNCTION hFunc) = 0;						 // M?cio: changed the return type 
			...
			*/
			...
			virtual void EndCall(nMech::nLUA1::IScriptObject *pScriptObject)=0;
			//##@}
			...
			*/
			...
			virtual void PushFuncParam(nMech::nLUA1::IScriptObject *pVal) = 0;
			//##@}
			...
			*/
			...
			virtual void SetGlobalValue(const char *sKey, nMech::nLUA1::IScriptObject *pObj) = 0;
			//##@}
			...
			virtual bool GetGlobalValue(const char *sKey, nMech::nLUA1::IScriptObject *pObj) = 0;
			...
			*/
			...
			virtual nMech::nLUA1::IScriptObject *GetBreakPoints() = 0;
			virtual HBREAKPOINT AddBreakPoint(const char *sFile,int nLineNumber)=0;
			virtual nMech::nLUA1::IScriptObject *GetLocalVariables(int nLevel = 0) = 0;
			...
			*/
			virtual nMech::nLUA1::IScriptObject *GetCallsStack() = 0;
		...
		struct IScriptObject
		{
			...
			virtual void Attach(nMech::nLUA1::IScriptObject *so) = 0;

			virtual void Delegate(nMech::nLUA1::IScriptObject *pObj) = 0;
			...
			virtual void PushBack(nMech::nLUA1::IScriptObject *pObj) = 0;
			...
			*/
			...
			virtual void SetValue(const char *sKey, nMech::nLUA1::IScriptObject *pObj) = 0;
			...
			*/
			...
			//#endif
			virtual bool GetValue(const char *sKey, nMech::nLUA1::IScriptObject *pObj) = 0;
			...
			*/
			...
			virtual bool GetValueChain(const char *sKey, nMech::nLUA1::IScriptObject *pObj) = 0;
			...
			virtual void SetValueChain(const char *sKey, nMech::nLUA1::IScriptObject *pObj) = 0;
			...
			*/
			...
			virtual void SetAt(int nIdx,nMech::nLUA1::IScriptObject *pObj)=0;
			...
			*/
			...
			virtual bool GetAt(int nIdx,nMech::nLUA1::IScriptObject *pObj)=0;
			...
			virtual bool GetCurrent(char* &sVal) = 0;
			virtual bool GetCurrent(const char* &sVal) = 0;
			virtual bool GetCurrent(nMech::nLUA1::IScriptObject *pObj) = 0;
			...
			/* 
			*/
			virtual bool Clone(nMech::nLUA1::IScriptObject *pObj)=0;
			//DOC-IGNORE-BEGIN
			/*under development*/
		...
		struct IFunctionHandler
		{
			...
			*/
			...
			virtual bool GetParam(int nIdx, char * &s) = 0;
			...
			virtual bool GetParam(int nIdx, nMech::nLUA1::IScriptObject *pObj) = 0;
			...
			*/
			...
			virtual int EndFunction(nMech::nLUA1::IScriptObject *pObj) = 0;
		...
		class _SmartScriptObject
		{
			...
			_SmartScriptObject& operator =(nMech::nLUA1::IScriptObject *)
			{
				return *this;
			}
		public:
			...
			explicit _SmartScriptObject(IScriptSystem *pSS,nMech::nLUA1::IScriptObject *p)
			{
			...
			operator const nMech::nLUA1::IScriptObject*() const
			{
				return m_pSO;
			}
			operator nMech::nLUA1::IScriptObject*()
			{
				return m_pSO;
			}
			...
			bool  operator ==(const nMech::nLUA1::IScriptObject* p2) const 
			{
				return m_pSO == p2;
			};
			bool  operator ==(nMech::nLUA1::IScriptObject* p2) const 
			{
				return m_pSO == p2;
			};
			bool  operator !=(const nMech::nLUA1::IScriptObject* p2) const 
		...
		protected:
			nMech::nLUA1::IScriptObject *m_pSO;
		};

	}
	extern "C"{
		JC_GAMESCRIPTSYSTEM_API nMech::nLUA1::IScriptSystem *CreateScriptSystem( ISystem* pSys,nMech::nLUA1::IScriptSystemSink *pSink
			,nLUA1::IScriptDebugSink *pDebugSink,bool bStdLibs);
	}


	typedef nMech::nLUA1::IScriptSystem *(*CREATESCRIPTSYSTEM_FNCPTR)(ISystem* pSys,nMech::nLUA1::IScriptSystemSink *pSink
		,nMech::nLUA1::IScriptDebugSink *pDebugSink,bool bStdLibs);

	namespace nInterface
	{
		extern JBASE_API nMech::nLUA1::IScriptSystem *g_pIScriptSystem ;
	}
	...
	namespace nLUA1
	{
		...
		{
		public:
			_HScriptFunction(){m_hFunc=0;};
			_HScriptFunction(IScriptSystem *pSS){m_hFunc=0;}
			_HScriptFunction(IScriptSystem *pSS,HSCRIPTFUNCTION hFunc){m_hFunc=0;}
			~_HScriptFunction(){ if(m_hFunc)nInterface::g_pIScriptSystem->ReleaseFunc(m_hFunc);m_hFunc=0; }
			void Init(IScriptSystem *pSS,HSCRIPTFUNCTION hFunc){if(m_hFunc)nInterface::g_pIScriptSystem->ReleaseFunc(m_hFunc);m_hFunc=hFunc;}
			operator HSCRIPTFUNCTION() const
			{
				return m_hFunc;
			}
			_HScriptFunction& operator =(HSCRIPTFUNCTION f){
				if(m_hFunc)nInterface::g_pIScriptSystem->ReleaseFunc(m_hFunc);
				m_hFunc=f;
				return *this;
			}
		private:
