...
//	
//	File:jcCharMorphParams.h
//  Parameters for the morphing functions in jcICharInstance interface
//
//	History:
...
#ifndef _JCGAME_CHAR_MORPH_PARAMS_HDR_
#define _JCGAME_CHAR_MORPH_PARAMS_HDR_
