...
struct IMovieUser
{
	...
	virtual void PlaySubtitles( nMech::nJC_SOUND::ISound *pSound ) = 0;
};
...
struct IAnimTrack : public IRefCountBase
{
	...
	virtual void GetKey( int index,nMech::IKey *key ) = 0;
	...
	virtual void SetKey( int index,nMech::IKey *key ) = 0;
	...
	virtual void GetValue( float time,nMech::nMath::jVec3 &value ) = 0;
	virtual void GetValue( float time,nMech::nMath::Quat &value ) = 0;
	...
	virtual void SetValue( float time,const nMech::nMath::jVec3 &value,bool bDefault=false ) = 0;
	virtual void SetValue( float time,const nMech::nMath::Quat &value,bool bDefault=false ) = 0;
...
struct IAnimNode : public IRefCountBase
{
	...
	*/
	...
	virtual void SetPos( float time,const nMech::nMath::jVec3 &pos ) = 0;
	//! Rotate entity node.
	virtual void SetRotate( float time,const nMech::nMath::Quat &quat ) = 0;
	//! Scale entity node.
	virtual void SetScale( float time,const nMech::nMath::jVec3 &scale ) = 0;

	//! Get current entity position.
	virtual nMech::nMath::jVec3 GetPos() = 0;
	//! Get current entity rotation.
	virtual nMech::nMath::Quat GetRotate() = 0;
	//! Get current entity scale.
	virtual nMech::nMath::jVec3 GetScale() = 0;
	...
	*/
	virtual void GetWorldTM( nMech::nMath::Matrix44 &tm ) = 0;
