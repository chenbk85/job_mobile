...
public:
	...
	virtual void SetVertices(const nMech::nMath::jVec3d* pVertices, unsigned numVertices) = 0;
...
public:
	...
	virtual void AddTriangleWelded( vindex nV0, vindex nV1, vindex nV2, const nMech::nMath::jVec3d &vV0, const nMech::nMath::jVec3d &vV1, const nMech::nMath::jVec3d &vV2 )=0;
...
public:
	...
	virtual void BuildSilhuetteFromPos( const IStencilShadowConnectivity* pConnectivity, const nMech::nMath::jVec3d &invLightPos, const nMech::nMath::jVec3d* pDeformedVertices )=0;
	...
	virtual void BuildSilhuetteFromBitfield( const IStencilShadowConnectivity* pConnectivity, const nMech::nMath::jVec3d* inpVertices )=0;
	...
	virtual void meshShadowVolume (nMech::nMath::jVec3d vLight, float fFactor, nMech::nMath::jVec3d* outpVertexBuf, unsigned short* outpIndexBuf)=0;

	//! get memory usage
	virtual void GetMemoryUsage(class nMech::jcISizer * pSizer) {}
};
