...
//		delete &m_Address;
	...
	inline bool Load(nMech::nJC_stream::CStream &s);
	inline bool Save(nMech::nJC_stream::CStream &s);
public:
...
inline bool CIPAddress::Load(nMech::nJC_stream::CStream &s)
{
...
inline bool CIPAddress::Save(nMech::nJC_stream::CStream &s)
{
