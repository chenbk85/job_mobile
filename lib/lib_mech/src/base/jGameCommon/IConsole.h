...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	/*! Crate a new console variable
		...
		@return a pointer to the interface nMech::nCONSOLE::ICVar
		@see nMech::nCONSOLE::ICVar
	*/
	virtual nMech::nCONSOLE::ICVar *CreateVariable(const char *sName,const char *sValue,int nFlags, const char *help = "")=0;
	virtual nMech::nCONSOLE::ICVar *CreateVariable(const char *sName,int iValue,int nFlags, const char *help = "")=0;
	virtual nMech::nCONSOLE::ICVar *CreateVariable(const char *sName,float fValue,int nFlags, const char *help = "")=0;
////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	*/
	virtual void AddOutputPrintSink( nMech::nCONSOLE::IOutputPrintSink *inpSink )=0;
////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	*/
	virtual void RemoveOutputPrintSink( nMech::nCONSOLE::IOutputPrintSink *inpSink )=0;
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	*/
	virtual void DumpCVars(nMech::nCONSOLE::ICVarDumpSink *pCallback,unsigned int nFlagsFilter=0 )=0;
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	/*! Retrieve a console variable by name
		...
		@return a pointer to the nMech::nCONSOLE::ICVar interface, NULL if is not found
		@see nMech::nCONSOLE::ICVar
	*/
	virtual nMech::nCONSOLE::ICVar * GetCVar( const char *name, const bool bCaseSensitive=true )=0;
////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	/*! legacy function */
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	*/
	...
	virtual void DumpCommandsVars(tcstr prefix) = 0;

	//! Calculation of the memory used by the whole console system
	virtual void GetMemoryUsage (class nMech::jcISizer* pSizer) = 0;
	...
	@param Callback callback-interface which needs to be called for each element
	*/
	virtual void DumpKeyBinds(nMech::nCONSOLE::IKeyBindDumpSink *pCallback )=0;
	...
	virtual void AddConsoleVarSink( nMech::nCONSOLE::IConsoleVarSink *pSink )=0;
	//! Removes a console variables sink callback.
	virtual void RemoveConsoleVarSink( nMech::nCONSOLE::IConsoleVarSink *pSink )=0;
