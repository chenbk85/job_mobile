...
struct IStatObj: public IBindable
{
	...
	// Return Value:
	//     A nMech::nMath::jVec3 object countaining the bounding box.
	// Summary:
	//     Get the minimal bounding box component
	virtual nMech::nMath::jVec3 GetBoxMin()=0;

	// Return Value:
	//     A nMech::nMath::jVec3 object countaining the bounding box.
	// Summary:
	//     Get the minimal bounding box component
	virtual nMech::nMath::jVec3 GetBoxMax()=0;

	// Arguments:
	//     Minimum bounding box component
	// Summary:
	//     Set the minimum bounding box component
	virtual void	SetBBoxMin(const nMech::nMath::jVec3 &vBBoxMin)=0;

	// Arguments:
	//     Minimum bounding box component
	// Summary:
	//     Set the minimum bounding box component
	virtual void	SetBBoxMax(const nMech::nMath::jVec3 &vBBoxMax)=0;
...
//DOC-IGNORE-END
	...
	// Summary:
	//     Renders the object
	virtual void Render(const struct SRendParams & rParams, const nMech::nMath::jVec3& t, int nLodLevel=0)=0;
	...
	virtual const char *GetHelperById(int nId, nMech::nMath::jVec3 & vPos, nMech::nMath::Matrix44 * pMat = NULL, int * pnType = NULL)=0;
...
//DOC-IGNORE-END
	...
	virtual bool GetOcclusionVolume(list2<nMech::nMath::jVec3> * & plstOcclVolVerts, list2<int> * & plstOcclVolInds) = 0;
...
//DOC-IGNORE-BEGIN
	...
	virtual void GetMemoryUsage(class nMech::jcISizer* pSizer) {} // TODO: implement
//DOC-IGNORE-END
