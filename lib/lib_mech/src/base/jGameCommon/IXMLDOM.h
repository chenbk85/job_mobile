...
#ifdef JC_GAMEXMLDOM_EXPORTS
#define JC_GAMEXMLDOM_API __declspec(dllexport)
#else
#define JC_GAMEXMLDOM_API __declspec(dllimport)
#endif
#else
#define JC_GAMEXMLDOM_API
#endif
...
#if defined(LINUX)
inline nMech::nMath::jVec3 StringToVector(std::string str)
#else
inline nMech::nMath::jVec3 StringToVector(string str)
#endif
{
	nMech::nMath::jVec3 vTemp(0,0,0);
	float x,y,z;
...
JC_XMLDOM_API XDOM::IXMLDOMDocument *CreateDOMDocument();
