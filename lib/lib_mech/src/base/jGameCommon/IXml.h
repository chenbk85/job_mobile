...
public:
	...
	virtual void setAttr( const char* key,const nMech::nMath::jVec3 &value ) = 0;
	virtual void setAttr( const char* key,const nMech::nMath::Quat &value ) = 0;
	//////////////////////////////////////////////////////////////////////////
	// Inline Helpers.
	...
	virtual bool getAttr( const char *key,nMech::nMath::jVec3 &value ) const = 0;
	virtual bool getAttr( const char *key,nMech::nMath::Quat &value ) const = 0;
