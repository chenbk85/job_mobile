...
//    nScissorX1=nScissorY1=nScissorX2=nScissorY2=0;
  ...
  struct ShadowMapInfo{
    ...
    nMech::nMath::jVec3 vPrevTerShadowPos; 
...
struct IEntityRender
{
  IEntityRender()
  {
    ...
    m_pSector = 0; 
    m_pVisArea=0;
		m_vWSBoxMin=m_vWSBoxMax=nMech::nMath::jVec3(0,0,0);
	...
	virtual void	GetRenderBBox( nMech::nMath::jVec3 &mins,nMech::nMath::jVec3 &maxs ) = 0;
	virtual void	GetBBox( nMech::nMath::jVec3 &mins,nMech::nMath::jVec3 &maxs ) { GetRenderBBox( mins, maxs ); }
	virtual float GetRenderRadius() const = 0;
  virtual bool HasChanged() { return false; }
	virtual bool DrawEntity(const struct SRendParams & EntDrawParams) = 0;
	virtual bool IsStatic() const = 0;
  virtual struct IStatObj * GetEntityStatObj( unsigned int nSlot, nMech::nMath::Matrix44 * pMatrix = NULL, bool bReturnOnlyVisible = false) { return 0; }
  virtual void SetEntityStatObj( unsigned int nSlot, IStatObj * pStatObj, nMech::nMath::Matrix44 * pMatrix = NULL ) {};
	virtual struct jcICharInstance* GetEntityCharacter( unsigned int nSlot, nMech::nMath::Matrix44 * pMatrix = NULL ) { return 0; }
  ...
  nMech::nMath::jVec3 m_vWSBoxMin, m_vWSBoxMax;
  float m_fWSRadius;
//##  float m_fMaxViewDist;
  ...
  virtual void Serialize(bool bSave, nMech::nPAK::jIPak * pPak, FILE * f) {}
  ...
  virtual int GetMemoryUsage() { return 0; }
	...
	virtual void jSetRenderOption(nMech::cstr szCmd, void* pOption)=0;
};
