...
// -------------------------------------------------------------------------
//  File name:   jcAnimationScriptCommands.h
//  Version:     v1.00
//  Created:     1/15/2003 by Sergiy Migdalskiy
//  Compilers:   Visual Studio.NET
//  Description: Declarations necessary for scripting extensions to the
//               jc Character Animation subsyste.
// -------------------------------------------------------------------------
//  Notes:
//    This file is separated from the jcIAnimation.h for the sake of fast
...
#ifndef __JCGAME_ANIMATION_SCRIPT_COMMANDS_HDR__
#define __JCGAME_ANIMATION_SCRIPT_COMMANDS_HDR__

enum jcAnimationScriptCommandEnum
{
