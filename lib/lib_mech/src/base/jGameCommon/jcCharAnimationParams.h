#ifndef _JCGAME_COMMON_JCGAME_CHAR_ANIMATION_PARAMS_HDR_
#define _JCGAME_COMMON_JCGAME_CHAR_ANIMATION_PARAMS_HDR_

//////////////////////////////////////////////////////////////////////////
// This structure describes the parameters used to start an animation
// on a character.
struct jcCharAnimationParams
{
	jcCharAnimationParams(
	...
	// Summary:
	//   Flags used by jcCharAnimationParams to set the playback and synchronization of the animation.
	enum EFlagsEnum
	{
