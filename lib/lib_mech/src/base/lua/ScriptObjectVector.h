	...
	namespace nLUA
	{
		...
		*/
		...
		public:
			...
			CScriptObjectVector(jILua *pScriptSystem,bool bCreateEmpty=false):_SmartScriptObject(pScriptSystem,bCreateEmpty)
			{
			}

			void Set(const jVec3 &v)
			{
			...
			/*	jVec3& operator=(CScriptObjectVector &vec)
			{
			static jVec3 v3;
			vec.Set(v3);
			return v3;
			}*/
			CScriptObjectVector &operator=(const jVec3 &v3)
			{
				Set(v3);
				return *this;
			}
		...
		*/
		...
		{
		public:
			CScriptObjectColor(jILua *pScriptSystem,bool bCreateEmpty=false):_SmartScriptObject(pScriptSystem,bCreateEmpty)
			{
			}
			...
			CScriptObjectColor &operator=(const jVec3 &v3)
			{
				Set(v3);
				return *this;
			}
