...
#define PlugIn_ToFrontEnd PlugIn_ToFrontEnd_TS
#define PlugIn_ToBackEnd PlugIn_ToBackEnd_TS
#define jSERVER_NAME TestServer
#define jsSERVER_NAME _T("TestServer")
