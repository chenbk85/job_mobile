...
// TESTSERVER_API 함수를 DLL에서 가져오는 것으로 보고, 이 DLL은
// 이 DLL은 해당 매크로로 정의된 기호가 내보내지는 것으로 봅니다.
#ifdef TESTSERVER_EXPORTS
#define TESTSERVER_API __declspec(dllexport)
#else
#define TESTSERVER_API __declspec(dllimport)
#endif
