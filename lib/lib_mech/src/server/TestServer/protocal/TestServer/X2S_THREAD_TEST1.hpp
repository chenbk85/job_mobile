...
#ifndef TestServer___X2S_THREAD_TEST1__ 
#define TestServer___X2S_THREAD_TEST1__
...
{
	const int pk_X2S_THREAD_TEST1 = /*nMech::nNET::EProtocal_jINet_OGS_END+*/8000+6;
	/* uint8 type;*/
	/* wstring msg;*/
...
#endif //TestServer___X2S_THREAD_TEST1__