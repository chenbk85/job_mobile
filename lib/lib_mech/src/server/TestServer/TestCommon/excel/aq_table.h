...
#define for_each_nTESTSERVER_aq_table_Sys_STRUCT_LIST(STRUCT)\
	...
	#define for_each_nTESTSERVER_Sys_Avatar_STRUCT_FIELD(FIELD)\
		FIELD(asid                   ,아바타 ID             ,Sys_Avatar_id_t              ,0 , Sys_Avatar_id_t , Sys_Avatar_id_t , Sys_Avatar_id_t)\
		FIELD(name                   ,아바타 이름             ,tname32_t                    ,1 , tcstr , tcstr , t32)\
		FIELD(baseclass              ,아바타 상위직업           ,EAvatarClass                 ,2 , EAvatarClass , EAvatarClass , EAvatarClass)\
		FIELD(subclass               ,아바타 하위직업           ,EAvatarSubclass              ,3 , EAvatarSubclass , EAvatarSubclass , EAvatarSubclass)\
		...
		FIELD(combo1                 ,콤보공격1              ,Sys_Skill_id_t               ,33 , Sys_Skill_id_t , Sys_Skill_id_t , Sys_Skill_id_t)\
		FIELD(combo2                 ,콤보공격2              ,Sys_Skill_id_t               ,34 , Sys_Skill_id_t , Sys_Skill_id_t , Sys_Skill_id_t)\
		FIELD(combo3                 ,콤보공격3              ,Sys_Skill_id_t               ,35 , Sys_Skill_id_t , Sys_Skill_id_t , Sys_Skill_id_t)\
		FIELD(combo4                 ,콤보공격4              ,Sys_Skill_id_t               ,36 , Sys_Skill_id_t , Sys_Skill_id_t , Sys_Skill_id_t)\
		FIELD(combo5                 ,콤보공격5              ,Sys_Skill_id_t               ,37 , Sys_Skill_id_t , Sys_Skill_id_t , Sys_Skill_id_t)\
		FIELD(jump_atk               ,점프공격               ,Sys_Skill_id_t               ,38 , Sys_Skill_id_t , Sys_Skill_id_t , Sys_Skill_id_t)\
		FIELD(dash_atk               ,대쉬공격               ,Sys_Skill_id_t               ,39 , Sys_Skill_id_t , Sys_Skill_id_t , Sys_Skill_id_t)\
		FIELD(combo1_2h              ,양손콤보공격1            ,Sys_Skill_id_t               ,40 , Sys_Skill_id_t , Sys_Skill_id_t , Sys_Skill_id_t)\
		FIELD(combo2_2h              ,양손콤보공격2            ,Sys_Skill_id_t               ,41 , Sys_Skill_id_t , Sys_Skill_id_t , Sys_Skill_id_t)\
		FIELD(combo3_3h              ,양손콤보공격3            ,Sys_Skill_id_t               ,42 , Sys_Skill_id_t , Sys_Skill_id_t , Sys_Skill_id_t)\
		FIELD(combo4_2h              ,양손콤보공격4            ,Sys_Skill_id_t               ,43 , Sys_Skill_id_t , Sys_Skill_id_t , Sys_Skill_id_t)\
		FIELD(combo5_2h              ,양손콤보공격5            ,Sys_Skill_id_t               ,44 , Sys_Skill_id_t , Sys_Skill_id_t , Sys_Skill_id_t)\
		FIELD(jump_atk_2h            ,양손점프공격             ,Sys_Skill_id_t               ,45 , Sys_Skill_id_t , Sys_Skill_id_t , Sys_Skill_id_t)\
		FIELD(dash_atk_2h            ,양손대쉬공격             ,Sys_Skill_id_t               ,46 , Sys_Skill_id_t , Sys_Skill_id_t , Sys_Skill_id_t)\
	...
	#define for_each_nTESTSERVER_Sys_Item_STRUCT_FIELD(FIELD)\
		FIELD(isid                   ,아이템 ID             ,Sys_Item_id_t                ,0 , Sys_Item_id_t , Sys_Item_id_t , Sys_Item_id_t)\
		FIELD(name                   ,아이템 이름             ,tname32_t                    ,1 , tcstr , tcstr , t32)\
		FIELD(category               ,아이템 대분류            ,EItemClass                   ,2 , EItemClass , EItemClass , EItemClass)\
		FIELD(subcategory            ,아이템 소분류            ,EItemSubclass                ,3 , EItemSubclass , EItemSubclass , EItemSubclass)\
		FIELD(grade                  ,아이템 등급             ,EItemGrade                   ,4 , EItemGrade , EItemGrade , EItemGrade)\
		FIELD(quality                ,아이템 품질             ,EItemQuality                 ,5 , EItemQuality , EItemQuality , EItemQuality)\
		FIELD(bind_type              ,아이템 귀속 여부          ,EItemBind                    ,6 , EItemBind , EItemBind , EItemBind)\
		FIELD(part                   ,아이템 착용 부위          ,EAvatarParts                 ,7 , EAvatarParts , EAvatarParts , EAvatarParts)\
		FIELD(reqClass               ,아이팀 사용 상위직업        ,EAvatarClass                 ,8 , EAvatarClass , EAvatarClass , EAvatarClass)\
		FIELD(reqSubclass            ,아이템 사용 하위직업        ,EAvatarSubclass              ,9 , EAvatarSubclass , EAvatarSubclass , EAvatarSubclass)\
	...
	#define for_each_nTESTSERVER_Sys_Skill_STRUCT_FIELD(FIELD)\
		FIELD(ssid                   ,스킬 ID              ,Sys_Skill_id_t               ,0 , Sys_Skill_id_t , Sys_Skill_id_t , Sys_Skill_id_t)\
		FIELD(name                   ,스킬 이름              ,tname32_t                    ,1 , tcstr , tcstr , t32)\
		FIELD(level                  ,스킬 레벨              ,skill_level_t                ,2 , skill_level_t , skill_level_t , skill_level_t)\
		...
		FIELD(reqItem                ,스킬 사용시 필요 아이템      ,Sys_Item_id_t                ,7 , Sys_Item_id_t , Sys_Item_id_t , Sys_Item_id_t)\
		FIELD(costHP                 ,스킬 사용시 소모되는 hp     ,int32                        ,8 , int32 , int32 , i32)\
		FIELD(costMP                 ,스킬 사용시 소모되는 mp     ,int32                        ,9 , int32 , int32 , i32)\
		FIELD(costItem               ,스킬 사용시 소모되는 아이템    ,Sys_Item_id_t                ,10 , Sys_Item_id_t , Sys_Item_id_t , Sys_Item_id_t)\
		FIELD(type                   ,스킬 타입              ,ESkillType                   ,11 , ESkillType , ESkillType , ESkillType)\
		FIELD(castingType            ,스킬 캐스팅 타입          ,ESkillCastType               ,12 , ESkillCastType , ESkillCastType , ESkillCastType)\
		...
		FIELD(target                 ,스킬 적용대상            ,ETarget                      ,19 , ETarget , ETarget , ETarget)\
		FIELD(attackType             ,스킬 공격 리액션 타입       ,EAttackType                  ,20 , EAttackType , EAttackType , EAttackType)\
