...
#ifndef __namespace_nTESTSERVER___filename_sam_world_
#define __namespace_nTESTSERVER___filename_sam_world_

#include "table_const_sam_world.h"
// -------------------------------------------------
// enum형 코드 템플릿 정의
// -------------------------------------------------
// ENUM_TABLE(enum_tbl,help,root_ns,ns)
#define for_each_nTESTSERVER_sam_world_ENUM(ENUM_TABLE)\
	ENUM_TABLE(EIssue_Info,설명없음,nMech,nTESTSERVER)\
	ENUM_TABLE(ETile_Sort,설명없음,nMech,nTESTSERVER)\
	...
	/* 설명없음 */
	#define for_each_nTESTSERVER_EIssue_Info_ENUM_FIELD(ENUM_FIELD)\
		ENUM_FIELD(EII_NORMAL			,1,일반,nMech,nTESTSERVER,EIssue_Info)\
		ENUM_FIELD(EII_NEW			,2,신규,nMech,nTESTSERVER,EIssue_Info)\
		ENUM_FIELD(EII_RECOMMEND			,3,추천,nMech,nTESTSERVER,EIssue_Info)\
		ENUM_FIELD(EII_TEST			,4,테스트용,nMech,nTESTSERVER,EIssue_Info)\

	/* 설명없음 */
	#define for_each_nTESTSERVER_ETile_Sort_ENUM_FIELD(ENUM_FIELD)\
		ENUM_FIELD(ETS_ROAD			,1,도로,nMech,nTESTSERVER,ETile_Sort)\
		ENUM_FIELD(ETS_MEADOW			,2,초원,nMech,nTESTSERVER,ETile_Sort)\
		ENUM_FIELD(ETS_LAND			,3,평지,nMech,nTESTSERVER,ETile_Sort)\
		ENUM_FIELD(ETS_MOUNT			,4,산악,nMech,nTESTSERVER,ETile_Sort)\
		ENUM_FIELD(ETS_RIVER			,5,강,nMech,nTESTSERVER,ETile_Sort)\
		ENUM_FIELD(ETS_SEA			,6,바다,nMech,nTESTSERVER,ETile_Sort)\
		ENUM_FIELD(ETS_SWAMP			,7,늪,nMech,nTESTSERVER,ETile_Sort)\


// -------------------------------------------------
// struct 코드 템플릿 정의
// -------------------------------------------------
#define for_each_nTESTSERVER_sam_world_Sys_STRUCT_LIST(STRUCT)\
	STRUCT(Sys_Tile,설명없음,nMech,nTESTSERVER)\
	STRUCT(Sys_World,설명없음,nMech,nTESTSERVER)\
	...
	#ifndef for_each_nTESTSERVER_Sys_Tile_STRUCT_FIELD
	#define for_each_nTESTSERVER_Sys_Tile_STRUCT_FIELD(FIELD)\
		FIELD(tisid                  ,숫자ID               ,Sys_Tile_id_t                ,0 , Sys_Tile_id_t , Sys_Tile_id_t , Sys_Tile_id_t)\
		...
		FIELD(sort                   ,분류                 ,ETile_Sort                   ,4 , ETile_Sort , ETile_Sort , ETile_Sort)\
	...
	#endif // for_each_nTESTSERVER_Sys_Tile_STRUCT_FIELD


	// ------------------------------------------------------------
	// Sys_Tile가 상속한 테이블들의 이름을 나열한 매크로.
	// FUNC(table)
	#ifndef for_each_nTESTSERVER_Sys_Tile_InheritedTable
	#define for_each_nTESTSERVER_Sys_Tile_InheritedTable(FUNC)\

	#endif // for_each_nTESTSERVER_Sys_Tile_InheritedTable


	// ------------------------------------------------------------
	// Sys_Tile가 상속한 테이블들의 필드만 나열한 매크로.
	// FUNC(eng_name,name,data_type,field_order,getter_type,setter_type,data_type_simple)
	#ifndef for_each_nTESTSERVER_Sys_Tile_STRUCT_FIELD_Inherited
	#define for_each_nTESTSERVER_Sys_Tile_STRUCT_FIELD_Inherited(FUNC)\

	#endif // for_each_nTESTSERVER_Sys_Tile_STRUCT_FIELD_Inherited


	// ------------------------------------------------------------
	// Sys_Tile가 상속한 테이블들의 모든필드와 자신의 필드들을 포함한 매크로.
	// FUNC(eng_name,name,data_type,field_order,getter_type,setter_type,data_type_simple)
	#ifndef for_each_nTESTSERVER_Sys_Tile_STRUCT_FIELD_all_member
	#define for_each_nTESTSERVER_Sys_Tile_STRUCT_FIELD_all_member(FUNC)\
		for_each_nTESTSERVER_Sys_Tile_STRUCT_FIELD_Inherited(FUNC)\
		for_each_nTESTSERVER_Sys_Tile_STRUCT_FIELD(FUNC)\

	#endif // for_each_nTESTSERVER_Sys_Tile_STRUCT_FIELD_all_member


	// ------------------------------------------------------------
	// Sys_World 자신의 필드만 나열한 매크로.
	// FUNC(eng_name,name,data_type,field_order,getter_type,setter_type,data_type_simple)
	#ifndef for_each_nTESTSERVER_Sys_World_STRUCT_FIELD
	#define for_each_nTESTSERVER_Sys_World_STRUCT_FIELD(FIELD)\
		FIELD(wsid                   ,숫자 ID              ,Sys_World_id_t               ,0 , Sys_World_id_t , Sys_World_id_t , Sys_World_id_t)\
		FIELD(name                   ,이름 ID              ,tname32_t                    ,1 , tcstr , tcstr , t32)\
		FIELD(name_kor               ,서버 이름              ,tname32_t                    ,2 , tcstr , tcstr , t32)\
		FIELD(issue                  ,이슈 상항              ,EIssue_Info                  ,3 , EIssue_Info , EIssue_Info , EIssue_Info)\
	...
	#endif // for_each_nTESTSERVER_Sys_World_STRUCT_FIELD


	// ------------------------------------------------------------
	// Sys_World가 상속한 테이블들의 이름을 나열한 매크로.
	// FUNC(table)
	#ifndef for_each_nTESTSERVER_Sys_World_InheritedTable
	#define for_each_nTESTSERVER_Sys_World_InheritedTable(FUNC)\

	#endif // for_each_nTESTSERVER_Sys_World_InheritedTable


	// ------------------------------------------------------------
	// Sys_World가 상속한 테이블들의 필드만 나열한 매크로.
	// FUNC(eng_name,name,data_type,field_order,getter_type,setter_type,data_type_simple)
	#ifndef for_each_nTESTSERVER_Sys_World_STRUCT_FIELD_Inherited
	#define for_each_nTESTSERVER_Sys_World_STRUCT_FIELD_Inherited(FUNC)\

	#endif // for_each_nTESTSERVER_Sys_World_STRUCT_FIELD_Inherited


	// ------------------------------------------------------------
	// Sys_World가 상속한 테이블들의 모든필드와 자신의 필드들을 포함한 매크로.
	// FUNC(eng_name,name,data_type,field_order,getter_type,setter_type,data_type_simple)
	#ifndef for_each_nTESTSERVER_Sys_World_STRUCT_FIELD_all_member
	#define for_each_nTESTSERVER_Sys_World_STRUCT_FIELD_all_member(FUNC)\
		for_each_nTESTSERVER_Sys_World_STRUCT_FIELD_Inherited(FUNC)\
		for_each_nTESTSERVER_Sys_World_STRUCT_FIELD(FUNC)\

	#endif // for_each_nTESTSERVER_Sys_World_STRUCT_FIELD_all_member
...
struct jEXCEL_LIB_API Sys_Tile /* 설명없음 */
{
	...
	enum enumSys_Tile
	{
		EField_BEGIN,
			...
			for_each_nTESTSERVER_Sys_Tile_STRUCT_FIELD(jEXCEL_STRUCT_ENUM_GEN)
	...
	static size_t Get_STRUCT_COUNT(){ return eSTRUCT_COUNT;} 
		...
		jEXCEL_TABLE_COMMON_CODE_H_Sys_Tile();
			...
			for_each_nTESTSERVER_Sys_Tile_STRUCT_FIELD(jEXCEL_STRUCT_GETTER_SETTER_GEN)
...
struct jEXCEL_LIB_API Sys_World /* 설명없음 */
{
	...
	enum enumSys_World
	{
		EField_BEGIN,
		#ifdef jEXCEL_STRUCT_ENUM_GEN
			for_each_nTESTSERVER_Sys_World_STRUCT_FIELD(jEXCEL_STRUCT_ENUM_GEN)
		#endif //jEXCEL_STRUCT_ENUM_GEN
		EField_END
	};
	...
	#ifdef jEXCEL_SERVER_SIDE_CODE
		#ifdef jEXCEL_STRUCT_GETTER_SETTER_GEN
			for_each_nTESTSERVER_Sys_World_STRUCT_FIELD(jEXCEL_STRUCT_GETTER_SETTER_GEN)
		#endif //jEXCEL_STRUCT_GETTER_SETTER_GEN
...
extern jEXCEL_LIB_API CSV_Sys_World g_Sys_World;
	...
	for_each_nTESTSERVER_sam_world_Sys_STRUCT_LIST(jEXCEL_TABLE_COMMON_CODE_H_Sys);
	...
	namespace nExcelUtil{
		using namespace nMech::nTESTSERVER;
			...
			for_each_nTESTSERVER_sam_world_ENUM(jEXCEL_ENUM_StringToVal);
		#endif //jEXCEL_ENUM_StringToVal



		#ifdef jEXCEL_struct_header_default_function
			for_each_nTESTSERVER_sam_world_Sys_STRUCT_LIST(jEXCEL_struct_header_default_function);
	...
	using namespace nMech::nTESTSERVER;
	for_each_nTESTSERVER_sam_world_Sys_STRUCT_LIST(jEXCEL_SQ_DECLARE_INSTANCE_TYPE);

#endif //jNOT_USE_SQ_BIND_CODE



#endif //__namespace_nTESTSERVER___filename_sam_world_
