...
#define for_each_nTESTSERVER_sam_npc_Sys_STRUCT_LIST(STRUCT)\
	...
	#define for_each_nTESTSERVER_Sys_Monster_STRUCT_FIELD(FIELD)\
		FIELD(msid                   ,ID                 ,Sys_Monster_id_t             ,0 , Sys_Monster_id_t , Sys_Monster_id_t , Sys_Monster_id_t)\
		FIELD(name                   ,이름                 ,tname32_t                    ,1 , tcstr , tcstr , t32)\
		FIELD(rank                   ,등급                 ,EMobRank                     ,2 , EMobRank , EMobRank , EMobRank)\
		...
		FIELD(skill1                 ,스킬1                ,skill_sid_t                  ,14 , skill_sid_t , skill_sid_t , skill_sid_t)\
		FIELD(skill2                 ,스킬2                ,skill_sid_t                  ,15 , skill_sid_t , skill_sid_t , skill_sid_t)\
		FIELD(skill3                 ,스킬3                ,skill_sid_t                  ,16 , skill_sid_t , skill_sid_t , skill_sid_t)\
		FIELD(skill4                 ,스킬4                ,skill_sid_t                  ,17 , skill_sid_t , skill_sid_t , skill_sid_t)\
		FIELD(skill5                 ,스킬5                ,skill_sid_t                  ,18 , skill_sid_t , skill_sid_t , skill_sid_t)\
