...
namespace nMech
{
	namespace nUtil
	{
		...
		{
			typedef nNET::jPacket_Info  jPacket_Info;
			typedef nNET::jPacket_Base  jPacket_Base;
			typedef nNET::jPacketNum_t  jPacketNum_t;
...
#pragma pack()
			...
			class COptEx
			{
				nUtil::nDB::jOptMutex *m_cs;

			public:
				COptEx(nUtil::nDB::jOptMutex& cs)
				{
					m_cs = &cs;
