...
namespace nMech
{
	...
	#if defined(jEXCEL_TABLE_COMMON_CODE_CPP_SQ_GLOBAL_Sys) && defined(for_each_nTESTSERVER_ClientResult_Sys_STRUCT_LIST)
		for_each_nTESTSERVER_ClientResult_Sys_STRUCT_LIST(jEXCEL_TABLE_COMMON_CODE_CPP_SQ_GLOBAL_Sys);
	#endif //jEXCEL_TABLE_COMMON_CODE_CPP_SQ_GLOBAL_Sys


	#ifdef jEXCEL_TABLE_COMMON_CODE_CPP_SQ_GLOBAL_Tbl
		for_each_nTESTSERVER_ClientResult_Tbl_STRUCT_LIST(jEXCEL_TABLE_COMMON_CODE_CPP_SQ_GLOBAL_Tbl);
...
namespace nMech {
	...
	tcstr Sys_ClientResult::Get_description()	{		return (tcstr)m_description;}
	...
	for_each_nTESTSERVER_ClientResult_Sys_STRUCT_LIST(jEXCEL_TABLE_COMMON_CODE_CPP_Sys);
...
{	tname1024_t szBuf;
	...
	for_each_nTESTSERVER_Sys_ClientResult_STRUCT_FIELD_all_member(jEXCEL_STRUCT_FIELD_DebugPrint);
}
	...
	{
		jSQ_REGIST_BIND(nMech_nTESTSERVER_ClientResult)
		{
			...
			for_each_nTESTSERVER_Sys_ClientResult_STRUCT_FIELD(jEXCEL_SQ_TABLE_FILED_BIND);
