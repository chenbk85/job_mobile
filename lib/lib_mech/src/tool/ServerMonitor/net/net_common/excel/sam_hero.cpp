...
namespace nMech
{
	...
	#if defined(jEXCEL_TABLE_COMMON_CODE_CPP_SQ_GLOBAL_Sys) && defined(for_each_nTESTSERVER_sam_hero_Sys_STRUCT_LIST)
		for_each_nTESTSERVER_sam_hero_Sys_STRUCT_LIST(jEXCEL_TABLE_COMMON_CODE_CPP_SQ_GLOBAL_Sys);
	#endif //jEXCEL_TABLE_COMMON_CODE_CPP_SQ_GLOBAL_Sys


	#ifdef jEXCEL_TABLE_COMMON_CODE_CPP_SQ_GLOBAL_Tbl
		for_each_nTESTSERVER_sam_hero_Tbl_STRUCT_LIST(jEXCEL_TABLE_COMMON_CODE_CPP_SQ_GLOBAL_Tbl);
	#endif //jEXCEL_TABLE_COMMON_CODE_CPP_SQ_GLOBAL_Tbl

#endif //jNOT_USE_SQ_BIND_CODE


for_each_nTESTSERVER_sam_hero_ENUM(jEXCEL_SQ_DECLARE_ENUM_TYPE);
namespace nMech {
	namespace nTESTSERVER {
...
jEXCEL_LIB_API nExcelUtil::jEnumString g_ES_EDeckYear[] = 
{
	{ 2 , 0, 0},
		...
		for_each_nTESTSERVER_EDeckYear_ENUM_FIELD(jEXCEL_ENUM_STRING_CPP_CODE)
...
jEXCEL_LIB_API nExcelUtil::jEnumString g_ES_EHeroCategory[] = 
{
	{ 2 , 0, 0},
	#ifdef jEXCEL_ENUM_STRING_CPP_CODE
		for_each_nTESTSERVER_EHeroCategory_ENUM_FIELD(jEXCEL_ENUM_STRING_CPP_CODE)
	#endif // jEXCEL_ENUM_STRING_CPP_CODE
};
jEXCEL_LIB_API nExcelUtil::jEnumString g_ES_EHeroEngagementtype[] = 
{
	{ 2 , 0, 0},
	#ifdef jEXCEL_ENUM_STRING_CPP_CODE
		for_each_nTESTSERVER_EHeroEngagementtype_ENUM_FIELD(jEXCEL_ENUM_STRING_CPP_CODE)
	#endif // jEXCEL_ENUM_STRING_CPP_CODE
};
jEXCEL_LIB_API nExcelUtil::jEnumString g_ES_EHeroFacetype[] = 
{
	{ 4 , 0, 0},
	#ifdef jEXCEL_ENUM_STRING_CPP_CODE
		for_each_nTESTSERVER_EHeroFacetype_ENUM_FIELD(jEXCEL_ENUM_STRING_CPP_CODE)
	#endif // jEXCEL_ENUM_STRING_CPP_CODE
};
jEXCEL_LIB_API nExcelUtil::jEnumString g_ES_EHeroPersonality[] = 
{
	{ 4 , 0, 0},
	#ifdef jEXCEL_ENUM_STRING_CPP_CODE
		for_each_nTESTSERVER_EHeroPersonality_ENUM_FIELD(jEXCEL_ENUM_STRING_CPP_CODE)
	#endif // jEXCEL_ENUM_STRING_CPP_CODE
};
jEXCEL_LIB_API nExcelUtil::jEnumString g_ES_EHeroSex[] = 
{
	{ 2 , 0, 0},
	#ifdef jEXCEL_ENUM_STRING_CPP_CODE
		for_each_nTESTSERVER_EHeroSex_ENUM_FIELD(jEXCEL_ENUM_STRING_CPP_CODE)
	#endif // jEXCEL_ENUM_STRING_CPP_CODE
};
jEXCEL_LIB_API nExcelUtil::jEnumString g_ES_EHeroWorkState[] = 
{
	{ 4 , 0, 0},
	#ifdef jEXCEL_ENUM_STRING_CPP_CODE
		for_each_nTESTSERVER_EHeroWorkState_ENUM_FIELD(jEXCEL_ENUM_STRING_CPP_CODE)
	#endif // jEXCEL_ENUM_STRING_CPP_CODE
};
	...
	for_each_nTESTSERVER_sam_hero_Sys_STRUCT_LIST(jEXCEL_TABLE_COMMON_CODE_CPP_Sys);
...
{	tname1024_t szBuf;
	...
	for_each_nTESTSERVER_Sys_Hero_STRUCT_FIELD_all_member(jEXCEL_STRUCT_FIELD_DebugPrint);
}
	...
	{
		jSQ_REGIST_BIND(nMech_nTESTSERVER_sam_hero)
		{
			{
				SquirrelObject enumRoot= nSQ::jSQ_GetEnumTable();
				for_each_nTESTSERVER_sam_hero_ENUM(jEXCEL_SQ_bind_EnumField_BEGIN);
				for_each_nTESTSERVER_EDeckYear_ENUM_FIELD(jEXCEL_SQ_bind_EnumField);
				for_each_nTESTSERVER_EHeroCategory_ENUM_FIELD(jEXCEL_SQ_bind_EnumField);
				for_each_nTESTSERVER_EHeroEngagementtype_ENUM_FIELD(jEXCEL_SQ_bind_EnumField);
				for_each_nTESTSERVER_EHeroFacetype_ENUM_FIELD(jEXCEL_SQ_bind_EnumField);
				for_each_nTESTSERVER_EHeroPersonality_ENUM_FIELD(jEXCEL_SQ_bind_EnumField);
				for_each_nTESTSERVER_EHeroSex_ENUM_FIELD(jEXCEL_SQ_bind_EnumField);
				for_each_nTESTSERVER_EHeroWorkState_ENUM_FIELD(jEXCEL_SQ_bind_EnumField);
			}
			...
			for_each_nTESTSERVER_Sys_Hero_STRUCT_FIELD(jEXCEL_SQ_TABLE_FILED_BIND);
