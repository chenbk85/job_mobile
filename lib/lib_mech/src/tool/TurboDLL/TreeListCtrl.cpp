...
#endif
jxDEFINE(OnLButtonUp);
jxDEFINE(OnLButtonDblClk);
jxDEFINE(OnRButtonDown);
jxDEFINE(OnRButtonUp);
...
void CTreeListCtrl::OnLButtonDown(UINT nFlags, CPoint point) 
{
	...
	Event_t* pEvent = GetEvent(jx(OnLButtonDown));
	if(pEvent) (*pEvent)(this, nFlags,point);
...
void CTreeListCtrl::OnLButtonUp(UINT nFlags, CPoint point) 
{
	...
	else
	{
		...
		Event_t* pEvent = GetEvent(jx(OnLButtonUp));
		if(pEvent) (*pEvent)(this, pItem , point);
	}
...
void CTreeListCtrl::OnLButtonDblClk(UINT nFlags, CPoint point) 
{
	...
	Event_t* pEvent = GetEvent(jx(OnLButtonDblClk));
	if(pEvent) (*pEvent)(this, pItem , point);
...
void CTreeListCtrl::OnRButtonDown(UINT nFlags, CPoint point) 
{
	...
	Event_t* pEvent = GetEvent(jx(OnRButtonDown));
	if(pEvent) (*pEvent)(this, nFlags , point);
...
void CTreeListCtrl::OnRButtonUp(UINT nFlags, CPoint point) 
{
	...
	Event_t* pEvent = GetEvent(jx(OnRButtonUp));
	if(pEvent) (*pEvent)(this, nFlags , point);
