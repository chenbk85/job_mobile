//////////////////////////////////////////////////////////////////////////
// this is the unique nMech::nJC_stream::IReadStream* interface implementation,
...
#ifndef _JCGAME_SYSTEM_READ_STREAM_PROXY_HDR_
#define _JCGAME_SYSTEM_READ_STREAM_PROXY_HDR_
...
namespace nMech
{
	namespace nPAK
	{
		...
		class CRefReadStreamProxy: public nMech::nJC_stream::IReadStream
		{
		public:
			...
			CRefReadStreamProxy (const char* szSource
				, class CRefReadStream* pStream
						, nMech::nJC_stream::IStreamCallback* pCallback
						, nMech::nJC_stream::StreamReadParams* pParams);
			~CRefReadStreamProxy ();
			...
			const nMech::nJC_stream::StreamReadParams& GetParams() const {return m_Params;}
		...
		protected:
			...
			nMech::nJC_stream::StreamReadParams m_Params;
			// the source for debugging
			string m_strClient;
			// the callback; may be NULL
			nMech::nJC_stream::IStreamCallback* m_pCallback;
