...
#ifndef JC_GAMESOUND_SOUND_H
#define JC_GAMESOUND_SOUND_H
...
#define SOUND_PRELOAD_DISTANCE	15	// start preloading this amount of meters before the sound is potentially hearable (max_radius)
		...
		//////////////////////////////////////////////////////////////////////////////////////////////
		// A sound...
		class CSound : public nMech::nJC_SOUND::ISound
		{
		protected:
			virtual ~CSound();
		public:
			...
			const bool GetPosition(jVec3d &vPos);	
		...
		public:
			...
			jVec3_tpl<float>	m_position;
			jVec3_tpl<float>	m_orient;
			jVec3_tpl<float>	m_speed;
			int m_refCount;
			int   m_nFlags;
			jVec3_tpl<float>	m_RealPos;	// this is the position the sound is currently at (may differ from m_position, because for example the directional attenuation will virtually "move" the sound)
			...
			class CSoundSystem* m_pSoundSystem;
