...
#ifdef PS2
inline void __jcGameDLL_TRACE(const char *sFormat, ... )
#else
_inline void __cdecl __jcGameDLL_TRACE(const char *sFormat, ... )
#endif
{
	va_list vl;
...
#define TRACE __jcGameDLL_TRACE
...
using namespace nMech::nMath;
using namespace nMech::nInterface;
using namespace nMech::nJC;
using namespace nMech::nINPUT;
using namespace nMech::nLOG;
using namespace nMech::nLUA1;
using namespace nMech::nJC_SOUND;
