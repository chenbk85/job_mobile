...
namespace nMech
{
	namespace nJC_SOUND
	{
		...
		protected:
			...
			nMech::nCONSOLE::ICVar	*m_pCVarDebugMusic;
			nMech::nCONSOLE::ICVar	*m_pCVarMusicEnable;
			nMech::nCONSOLE::ICVar	*m_pCVarMusicMaxSimultaniousPatterns;
			nMech::nCONSOLE::ICVar	*m_pCVarMusicStreamedData;
			int m_musicEnable;
		protected:
