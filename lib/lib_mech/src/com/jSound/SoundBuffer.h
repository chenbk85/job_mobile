...
namespace nMech
{
	namespace nJC_SOUND
	{
		...
		class CSoundBuffer : nMech::nJC_stream::IStreamCallback
		{
		private:
			union tagData
			{
		...
		protected:
			...
			int	m_nBaseFreq;
			float m_fLength;
			nMech::nJC_stream::IReadStreamPtr m_pReadStream;
			bool m_bLoadFailure;
			bool m_bLooping;
		...
		protected:
			...
			virtual void StreamOnComplete(nMech::nJC_stream::IReadStream *pStream, unsigned nError);
			void SoundLoaded();
			void LoadFailed();
