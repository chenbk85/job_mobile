...
/////////////////////////////////////////////////////////////////
class CDummySound : public nMech::nJC_SOUND::ISound
{
public:
	CDummySound()
	{		
	...
	void	SetAttrib(const jVec3d &pos, const jVec3d &speed){}
	void	SetRatio(float fRatio){}
	void	SetPosition(const jVec3d &pos){}
	const bool GetPosition(jVec3d &vPos){return (false);}
	void	SetSpeed(const jVec3d &speed){}
	const jVec3d& GetSpeed(){return m_vDummy;}
	...
	void	SetVelocity(const jVec3d &vVel) {}
	jVec3d	GetVelocity() {return (jVec3d(0,0,0));}
	void	SetDirection(const jVec3d &vDir) {}
	jVec3d	GetDirection() {return (jVec3d(0,0,0));}	
...
{
public:
	CDummySoundSystem(HWND hWnd) : CSoundSystemCommon() {}
	~CDummySoundSystem()
  {
	...
	{ 
		nInterface::g_pIMusicSystem = new CDummyMusicSystem(); 
		return g_pIMusicSystem;
	}
	nMech::nJC_SOUND::ISound* LoadSound(const char *szFile, int nFlags) { return &m_sndDummy; }
	void		RemoveSound(int nSoundID){}
	nMech::nJC_SOUND::ISound* GetSound(int nSoundID){ return &m_sndDummy;}
	...
	//void		SetListener(const jVec3d &vPos,const jVec3d &vVel,const jVec3d& vAngles) {}
	void		SetListener(const nMech::nMath::CCamera &cCam, const jVec3d &vVel) {}
	jVec3d		GetListenerPos() {return(jVec3d(0,0,0));}
	...
	void CalcDirectionalAttenuation(jVec3d &Pos, jVec3d &Dir, float fConeInRadians) {}
