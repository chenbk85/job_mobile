...
#ifndef JC_GAMESOUND_SOUNDSYSTEM_H
#define JC_GAMESOUND_SOUNDSYSTEM_H
...
#undef PlaySound
		...
		public:
			...
			*/
			nMech::nJC_SOUND::ISound* LoadSound(const char *szFile, int nFlags);
			...
			*/	
			...
			@param nSoundId sound id
			*/	
			nMech::nJC_SOUND::ISound* GetSound(int nSoundID);
			...
			*/
			...
			jVec3d			GetListenerPos() {return(m_cCam.GetPos());}
		...
		public:
			...
			nMech::nJC_stream::IStreamEngine *m_pStreamEngine;
			IVisArea	*m_pVisArea;
			...
			nMech::nMath::CCamera m_cCam;

			//listener infos
			jVec3d m_vPos,m_vForward,m_vTop;
...
#endif // JC_GAMESOUND_SOUNDSYSTEM_H
