#include "stdafx.h"
// *_* by icandoit : 2008-02-26 15:57:38
//#include "sqplus/sqplus.h"

namespace nMech { namespace nSQ{


BOOL jSquirrel::BindUtil_CreateStaticNamespace(HSQUIRRELVM v,ScriptNamespaceDecl *sn)
{
	int n = 0;
	sq_pushroottable(v);
...
BOOL jSquirrel::BindUtil_CreateClass(HSQUIRRELVM v,SquirrelClassDecl *cd)
{
	int n = 0;
...
BOOL jSquirrel::BindUtil_CreateNativeClassInstance(HSQUIRRELVM v,
                               ...
                               SQRELEASEHOOK hook)
{
  ...
  PopulateAncestry(v, instance, ud);
#endif
