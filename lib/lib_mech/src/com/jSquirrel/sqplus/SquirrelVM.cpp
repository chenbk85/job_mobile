...
// *_* by icandoit : 2008-02-26 15:58:28
...
namespace nMech
{
	namespace nSQ
	{
		void jSquirrel::VM_Init()
		{
			SquirrelVM::Init();
		}
		SquirrelObject jSquirrel::VM_CompileScript(const SQChar *s)
		{
			nFileSystem::jFolder dir;
			return SquirrelVM::CompileScript(s);
		}
		SquirrelObject jSquirrel::VM_CompileBuffer(const SQChar *s,const SQChar * debugInfo)
		{
			return SquirrelVM::CompileBuffer(s, debugInfo);
		}
		SquirrelObject jSquirrel::VM_RunScript(const SquirrelObject &o,SquirrelObject *_this)
		{
			return SquirrelVM::RunScript(o,_this);
		}
		BOOL jSquirrel::VM_BeginCall(const SquirrelObject &func) 
		{ 
			return SquirrelVM::BeginCall(func);
		}
		BOOL jSquirrel::VM_BeginCall(const SquirrelObject &func,SquirrelObject &_this) 
		{ 
			return SquirrelVM::BeginCall(func, _this);
		}
		void jSquirrel::VM_PushParam(const SquirrelObject &o) 
		{ 
			SquirrelVM::PushParam(o);
		}
		void jSquirrel::VM_PushParam(const SQChar *s) 
		{ 
			SquirrelVM::PushParam(s);
		}
		void jSquirrel::VM_PushParam(SQInteger n) 
		{ 
			SquirrelVM::PushParam(n);
		}
		void jSquirrel::VM_PushParam(SQFloat f) 
		{ 
			SquirrelVM::PushParam(f);
		}
		void jSquirrel::VM_PushParam(SQUserPointer up) 
		{ 
			SquirrelVM::PushParam(up);
		}
		void jSquirrel::VM_PushParamNull() 
		{ 
			SquirrelVM::PushParamNull();
		}
		SquirrelObject jSquirrel::VM_EndCall() 
		{ 
			return SquirrelVM::EndCall();
		}
		SquirrelObject jSquirrel::VM_CreateString(const SQChar *s) 
		{ 
			return SquirrelVM::CreateString(s);
		}
		SquirrelObject jSquirrel::VM_CreateTable() 
		{ 
			return SquirrelVM::CreateTable();
		}	
		SquirrelObject jSquirrel::VM_CreateArray(int size) 
		{ 
			return SquirrelVM::CreateArray(size);
		}
		/* oclass is an existing class. Create an 'instance' (OT_INSTANCE) of oclass.*/
		SquirrelObject jSquirrel::VM_CreateInstance(SquirrelObject &oclass) 
		{ 
			return SquirrelVM::CreateInstance(oclass);
		} 
		SquirrelObject jSquirrel::VM_CreateFunction(SQFUNCTION func) 
		{ 
			return SquirrelVM::CreateFunction(func);
		}
		SquirrelObject jSquirrel::VM_CreateUserData(int size) 
		{ 
			return SquirrelVM::CreateUserData(size);
		}
		const SquirrelObject &jSquirrel::VM_GetRootTable() 
		{ 
			return SquirrelVM::GetRootTable();
		}
		HSQUIRRELVM jSquirrel::VM_GetVMPtr() 
		{ 
			return SquirrelVM::GetVMPtr();
		}
		void jSquirrel::VM_PushValue(INT val) 
		{ 
			SquirrelVM::PushValue(val);
		}
		void jSquirrel::VM_PushValue(FLOAT val) 
		{ 
			SquirrelVM::PushValue(val);
		}
		void jSquirrel::VM_PushValue(bool val) 
		{ 
			SquirrelVM::PushValue(val);
		} 
		void jSquirrel::VM_PushValue(SQChar * val) 
		{ 
			SquirrelVM::PushValue(val);
		}
		void jSquirrel::VM_PushValue(SQUserPointer val) 
		{ 
			SquirrelVM::PushValue(val);
		}
		void jSquirrel::VM_PushValue(const SQChar * val) 
		{ 
			SquirrelVM::PushValue(val);
		}
		void jSquirrel::VM_PushObject(SquirrelObject & so) 
		{ 
			SquirrelVM::PushObject(so);
		}
		void jSquirrel::VM_Pop(SQInteger nelemstopop) 
		{ 
			SquirrelVM::Pop(nelemstopop);
		}
		void jSquirrel::VM_PushRootTable(void) 
		{ 
			SquirrelVM::PushRootTable();
		}

		SquirrelObject jSquirrel::VM_CreateFunction(SQFUNCTION func,const SQChar * scriptFuncName,const SQChar * typeMask)
		{
			return SquirrelVM::CreateFunction(func, scriptFuncName, typeMask);
		}
		SquirrelObject jSquirrel::VM_CreateFunction(SquirrelObject & so,SQFUNCTION func,const SQChar * scriptFuncName
																							,const SQChar * typeMask)
		{
			return SquirrelVM::CreateFunction(so,func, scriptFuncName, typeMask);
		}
		SquirrelObject jSquirrel::VM_CreateFunctionGlobal(SQFUNCTION func,const SQChar * scriptFuncName,const SQChar * typeMask)
		{
			return SquirrelVM::CreateFunctionGlobal(func, scriptFuncName, typeMask);
		}
...
void jSquirrel::init_SquirrelError(SquirrelError* se)
...
SquirrelObject SquirrelVM::CreateUserData(int size) {
  SquirrelObject ret;
  GetjISQ()->sq_newuserdata(_VM,size);
  ret.AttachToStackObject(-1);
