...
{
	SquirrelObject scriptedBase = SquirrelVM::CompileBuffer(_T(" \
								 class ScriptedBase \
								 { \
									 sbval = 5551212; \
	...
	SquirrelObject testInheritance = SquirrelVM::CompileBuffer(_T(" \
	...
	*/
	...
	SquirrelObject testReg0b = SquirrelVM::CompileBuffer(_T(" \
	...
	*/
	...
	SquirrelObject testReg0c = SquirrelVM::CompileBuffer(_T(" \
	...
	*/
	...
	SquirrelObject testReg0d = SquirrelVM::CompileBuffer(_T(" \
	...
	*/
	...
	SquirrelObject testReg1a = SquirrelVM::CompileBuffer(_T(" \
						co <- CustomTestObj(\"hello\",123,true); \
