...
//    sq_setprintfunc(SquirrelVM::GetVMPtr(),printfunc); //sets the print function.
  ...
  TestSqPlus() {
    ...
    try {
      ...
      Register(v,tr.GetObjectHandle(),t3,&NewTestObj::newtestR1
...
#if 1
      SquirrelObject testReg0 = SquirrelVM::CompileBuffer(_T(" co <- CustomTestObj(\"hello\",123,true); \
															 co.varArgTypes(\"str\",123,123,\"str\"); \
															 co.varArgTypes(123,\"str\",\"str\",123); "));
      SquirrelVM::RunScript(testReg0);

      SquirrelObject testReg0a = SquirrelVM::CompileBuffer(_T(" print(co.varArgTypesAndCount(1,true)); \
															  //print(co.varArgTypesAndCount(2,false,3.)); \n\
															  print(\"\\n\"); "));
      SquirrelVM::RunScript(testReg0a);

      SquirrelObject testReg0b = SquirrelVM::CompileBuffer(_T(" print(co.noArgsVariableReturn()); \
															  print(co.noArgsVariableReturn()); \
															  print(co.noArgsVariableReturn()); \
															  print(\"\\n\"); "));
      SquirrelVM::RunScript(testReg0b);

      SquirrelObject testReg0c = SquirrelVM::CompileBuffer(_T(" print(co.variableArgsFixedReturnType(1)); \
															  print(co.variableArgsFixedReturnType(1,2)); \
															  print(co.variableArgsFixedReturnType(1,2,3)); \
															  print(\"\\n\"); "));
      SquirrelVM::RunScript(testReg0c);

      SquirrelObject testReg0d = SquirrelVM::CompileBuffer(_T(" co.manyArgs(111,222.2,true,\"Hello\"); \
...
//      SquirrelObject testBaseDerived = SquirrelVM::CompileBuffer(_T(" local base = Base(); print(base.nameBase); local derived = Derived(); print(\"NameBase: \"+derived.nameBase+\" NameDerived: \"+derived.nameDerived); derived.funcBase(); "));
      SquirrelObject testBaseDerived = SquirrelVM::CompileBuffer(_T(" local derived = Derived(); \
																	print(\"NameBase: \"+derived.nameBase+\" NameDerived: \"+derived.nameDerived); \
																	derived.funcBase(); "));
      SquirrelVM::RunScript(testBaseDerived);
#endif

#if 1
      SquirrelObject testReg1a = SquirrelVM::CompileBuffer(_T(" co <- CustomTestObj(\"hello\",123,true); \
															  co.noArgsVariableReturn(); local t = NewTestObj(); \
															  print(\"C1: \"+t.c1); \
      ...
      SquirrelObject testReg1 = SquirrelVM::CompileBuffer(_T(" local t = NewTestObj(); t.newtestR1(\"Hello\"); \
															 t.val = 789; \
															 print(t.val); \
															 print(t.s1); \
															 print(t.s2); \
      ...
      SquirrelObject testReg2 = SquirrelVM::CompileBuffer(_T(" local t = NewTestObj(); \
															 t.val = 789; \
															 print(t.val); \
															 t.val = 876; \
															 print(t.val); \
      ...
      SquirrelObject testReg3 = SquirrelVM::CompileBuffer(_T(" test(); \
      ...
      SquirrelObject defCallFunc = SquirrelVM::CompileBuffer(_T(" function callMe(var) \
														{ \
...
//      SquirrelObject main = SquirrelVM::CompileBuffer(_T("testFunc0(); testFuncN(1); testFuncN(1.23); testFuncS(\"Hello\");"));
      ...
      SquirrelObject main = SquirrelVM::CompileBuffer(_T("\
      ...
      SquirrelObject bindvar_test = SquirrelVM::CompileBuffer(
 ...
 testString += \" : test\";\
	" ));
      SquirrelVM::RunScript(bindvar_test);
...
//      SquirrelObject test = SquirrelVM::CompileBuffer(_T(" print(iVar); print(fVar); print(bVar); iVar += 1; fVar += 100.; bVar = false; print(iVar); print(fVar); print(bVar); print(testString); testString = \"New string value\"; print(testString);"));
      SquirrelObject define_printArray = SquirrelVM::CompileBuffer(_T(" \
      ...
      SquirrelObject test = SquirrelVM::CompileBuffer(_T(" printArray(\"array\",array); \
