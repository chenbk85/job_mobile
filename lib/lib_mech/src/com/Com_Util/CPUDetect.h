/*=============================================================================
  ...
  Copyright 2001 jGame. All Rights Reserved.
...
#define CFI_SSE2  0x10
		...
		//--------------------------------------------------------------------------
		class CCpuFeatures : public jICpuInfo
			//--------------------------------------------------------------------------
		{
			jINTERFACE_HEADER(jIInterface);
			jINTERFACE_HEADER(jICpuInfo);
		private:
		...
		inline bool CCpuFeatures::hasSSE() { return (m_Cpu[0].mFeatures & CFI_SSE) != 0; }
		inline bool CCpuFeatures::hasSSE2() { return (m_Cpu[0].mFeatures & CFI_SSE2) != 0; }
		inline bool CCpuFeatures::has3DNow() { return (m_Cpu[0].mFeatures & CFI_3DNOW) != 0; }
		inline bool CCpuFeatures::hasMMX() { return (m_Cpu[0].mFeatures & CFI_MMX) != 0; }
		inline double CCpuFeatures::GetCpu_SecPerCycle(int cpuIndex){	return m_Cpu[cpuIndex].m_SecondsPerCycle;}

#if defined(AMD64) || defined(_WIN64) || defined(LINUX64)
		inline bool CCpuFeatures::IsAMD64()
		{
#ifdef _AMD64_
			return true;
#else
...
#else //#if defined(_WIN64) || defined(LINUX64)
		inline bool CCpuFeatures::IsAMD64()
		{
#if defined(LINUX32) && defined(_WIN64)
			return false;
#else
			_asm
			{
...
#endif // WIN32  #if defined(_WIN64) || defined(LINUX64)

	}
}

#endif //__CPUDETECT_H__
