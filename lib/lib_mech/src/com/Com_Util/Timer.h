...
//////////////////////////////////////////////////////////////////////
#include "interface/ITimer.h"						// ITimer
...
namespace nMech
{
	namespace nTIME
	{
		...
		public:
			...
			virtual TCHAR* GetCurrentTimeString(TCHAR	szCurrentTime[32]);
			virtual TCHAR* GetCurrentDateString(TCHAR szCurrentFileName[MAX_PATH]);
